...
/**
 * 
 * saas_adverse_reaction_together_goods
 * 
 * 
 * @author dudy
 * 
 * 2017-10-16
 */
public class AdverseReactionTogetherGoods implements Serializable {
    /**
     * 主键ID
     */
     ...
     * 单据（不良反应报告）ID
     */
    @ApiModelProperty(value = "单据（不良反应报告）ID")
