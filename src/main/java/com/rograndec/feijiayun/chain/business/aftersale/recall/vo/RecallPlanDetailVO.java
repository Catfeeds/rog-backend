 ...
 * 2017-10-16
 */
public class RecallPlanDetailVO implements Serializable {
    /**
     * 主键ID
     */
     ...
     * 单据（药品召回计划单）ID
     */
    @ApiModelProperty(value = "单据（药品召回计划单）ID")
    private Long planId;

    /**
     * 单据（药品召回计划单）类型
     */
    @ApiModelProperty(value = "单据（药品召回计划单）类型")
    private Integer orderType;

    /**
     * 单据（药品召回计划单）编码
     */
    @ApiModelProperty(value = "单据（药品召回计划单）编码")
    private String planCode;

    /**
     * 单据（药品召回计划单）日期
     */
    @ApiModelProperty(value = "单据（药品召回计划单）日期")
    ...
    /**
     * 单据（药品召回计划单）类型
     * @return order_type 单据（药品召回计划单）类型
     */
    ...
    /**
     * 单据（药品召回计划单）编码
     * @return plan_code 单据（药品召回计划单）编码
     */
    ...
    /**
     * 单据（药品召回计划单）日期
     * @return plan_date 单据（药品召回计划单）日期
     */
