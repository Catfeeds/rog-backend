 ...
 * 2017-10-16
 */
public class RecallRecordDetailVO implements Serializable {
    /**
     * 主键ID
     */
     ...
     * 单据（药品召回记录单）ID
     */
    @ApiModelProperty(value = "单据（药品召回记录单）ID")
    private Long recallId;

    /**
     * 单据（药品召回记录单）类型
     */
    @ApiModelProperty(value = "单据（药品召回记录单）类型")
    private Integer orderType;

    /**
     * 单据（药品召回记录单）编码
     */
    @ApiModelProperty(value = "单据（药品召回记录单）编码")
    private String recallCode;

    /**
     * 单据（药品召回记录单）日期
     */
    @ApiModelProperty(value = "单据（药品召回记录单）日期")
    private Date recallDate;

    /**
     * 基础单据明细ID(召回通知明细ID)
     */
    @ApiModelProperty(value = "基础单据明细ID(召回通知明细ID)")
    ...
    /**
     * 单据（药品召回记录单）ID
     * @return recall_id 单据（药品召回记录单）ID
     */
    ...
    /**
     * 单据（药品召回记录单）类型
     * @return order_type 单据（药品召回记录单）类型
     */
    ...
    /**
     * 单据（药品召回记录单）编码
     * @return recall_code 单据（药品召回记录单）编码
     */
    ...
    /**
     * 单据（药品召回记录单）编码
     * @param recallCode 单据（药品召回记录单）编码
     */
    ...
    /**
     * 单据（药品召回记录单）日期
     * @return recall_date 单据（药品召回记录单）日期
     */
    ...
    /**
     * 单据（药品召回记录单）日期
     * @param recallDate 单据（药品召回记录单）日期
     */
