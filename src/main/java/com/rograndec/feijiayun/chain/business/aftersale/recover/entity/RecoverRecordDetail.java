 ...
 * 2017-10-17
 */
public class RecoverRecordDetail implements Serializable {
    /**
     * 主键ID
     */
     ...
     * 单据（药品追回记录单）ID
     */
    @ApiModelProperty(value = "单据（药品追回记录单）ID")
    private Long recoverId;

    /**
     * 单据（药品追回记录单）类型
     */
    @ApiModelProperty(value = "单据（药品追回记录单）类型")
    private Integer orderType;

    /**
     * 单据（药品追回记录单）编码
     */
    @ApiModelProperty(value = "单据（药品追回记录单）编码")
    private String recoverCode;

    /**
     * 单据（药品追回记录单）日期
     */
    @ApiModelProperty(value = "单据（药品追回记录单）日期")
    ...
    /**
     * 单据（药品追回记录单）ID
     * @return recover_id 单据（药品追回记录单）ID
     */
    ...
    /**
     * 单据（药品追回记录单）类型
     * @return order_type 单据（药品追回记录单）类型
     */
    ...
    /**
     * 单据（药品追回记录单）编码
     * @return recover_code 单据（药品追回记录单）编码
     */
    ...
    /**
     * 单据（药品追回记录单）编码
     * @param recoverCode 单据（药品追回记录单）编码
     */
    public void setRecoverCode(String recoverCode) {
        this.recoverCode = recoverCode == null ? null : recoverCode.trim();
    }

    /**
     * 单据（药品追回记录单）日期
     * @return recover_date 单据（药品追回记录单）日期
     */
    ...
    /**
     * 单据（药品追回记录单）日期
     * @param recoverDate 单据（药品追回记录单）日期
     */
    ...
    /**
     * 未追回数量
     * @return unrecover_quantity 未追回数量
     */
    ...
    /**
     * 未追回原因
     * @param unrecoverReason 未追回原因
     */
    public void setUnrecoverReason(String unrecoverReason) {
        this.unrecoverReason = unrecoverReason == null ? null : unrecoverReason.trim();
    }

    /**
     * 是否医疗事故
     * @return medical_accident 是否医疗事故
     */
    ...
    /**
     * 是否医疗事故
     * @param medicalAccident 是否医疗事故
     */
    public void setMedicalAccident(String medicalAccident) {
        this.medicalAccident = medicalAccident == null ? null : medicalAccident.trim();
    }
    ...
    public String toString() {
        ...
        sb.append(", recoverId=").append(recoverId);
        sb.append(", orderType=").append(orderType);
        sb.append(", recoverCode=").append(recoverCode);
        sb.append(", recoverDate=").append(recoverDate);
        ...
        sb.append(", unrecoverQuantity=").append(unrecoverQuantity);
        sb.append(", unrecoverReason=").append(unrecoverReason);
        sb.append(", medicalAccident=").append(medicalAccident);
