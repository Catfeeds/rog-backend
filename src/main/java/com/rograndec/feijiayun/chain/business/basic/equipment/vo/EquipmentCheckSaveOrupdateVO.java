...
import javax.validation.constraints.NotNull;
 ...
 /**
 * 
 * @ClassName: EquipmentCheckSaveOrupdateVO
 * @Description:  设施设备-校准和检定-Rest接口
 * @author zhengbin.jin
 * @version 1.0 
 * @date 2017-10-16 13:18:06
 */
@ApiModel(value = "EquipmentCheckSaveOrupdateVO", description = "设施设备-校准和检定")
public class EquipmentCheckSaveOrupdateVO implements Serializable {
