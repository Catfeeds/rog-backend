...
@ApiModel(value = "AddStoreEnterpriseVO", description = "新增门店基本信息对象")
public class AddStoreEnterpriseVO implements Serializable {
	...
	List<EnterpriseQualificationConfigBean> qualificationConfigList;
    ...
    private String[] businessVarietyArray;
	...
	public String[] getBusinessVarietyArray() {
		return businessVarietyArray;
	}

	public void setBusinessVarietyArray(String[] businessVarietyArray) {
		this.businessVarietyArray = businessVarietyArray;
	}

	public List<EnterpriseQualificationConfigBean> getQualificationConfigList() {
		return qualificationConfigList;
	}

	public void setQualificationConfigList(
			List<EnterpriseQualificationConfigBean> qualificationConfigList) {
		this.qualificationConfigList = qualificationConfigList;
	}
