...
public class StoreExportVO implements Serializable {
    /**
     * 主键ID
     */
     ...
     */
	@ApiModelProperty(value = "最近搬迁日期")
    private String relocationDateString;
     ...
     */
	@ApiModelProperty(value = "最近改造日期")
    private String reformDateString;
     ...
     * 状态（0-禁用；1-启用）
     */
	@ApiModelProperty(value = "状态名称（0-禁用；1-启用）")
    ...
    private String[] businessScopeIdArray;
	 ...
	 * 付款账期
	 */
	@ApiModelProperty(required = true, value = "付款账期")
	private Integer paymentPeriod;
	
	/**
	 * 付款账期单位（0-天；1-月）
	 */
	@ApiModelProperty(required = true, value = "付款账期单位（0-天；1-月）")
	 ...
	 * 付款时间	
	 */
	@ApiModelProperty(required = true, value = "付款时间")
	private Integer paymentTime;
	
	/**
	 * 付款时间单位（0-每月；1-每周）
	 */
	@ApiModelProperty(required = true, value = "付款时间单位（0-每月；1-每周）")
	...
	public String[] getBusinessScopeIdArray() {
		return businessScopeIdArray;
	}

	public void setBusinessScopeIdArray(String[] businessScopeIdArray) {
	...
	public String getShopDateString() {
		return shopDateString;
	}

	public void setShopDateString(String shopDateString) {
		this.shopDateString = shopDateString;
	}

	public String getRelocationDateString() {
		return relocationDateString;
	}

	public void setRelocationDateString(String relocationDateString) {
		this.relocationDateString = relocationDateString;
	}

	public String getReformDateString() {
		return reformDateString;
	}

	public void setReformDateString(String reformDateString) {
		this.reformDateString = reformDateString;
	}
