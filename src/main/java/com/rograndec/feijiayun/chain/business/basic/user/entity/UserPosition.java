...
public class UserPosition implements Serializable {
    ...
    public static List<UserPosition> getUserUserPositions4VOs(List<Long> pIds, UserVO userVO, User user, boolean isAdd){
        List<UserPosition> userDepts = new ArrayList<>();

        for(Long did : pIds){
            UserPosition userPosition = getUserPosition4VO(did,userVO,user,isAdd);
            userDepts.add(userPosition);
        }
        return userDepts;
    }

    public static UserPosition getUserPosition4VO(Long pId, UserVO userVO, User user, boolean isAdd){

        UserPosition userPersonal = new UserPosition();
        ...
        userPersonal.setPositionId(pId);
        if(isAdd){
