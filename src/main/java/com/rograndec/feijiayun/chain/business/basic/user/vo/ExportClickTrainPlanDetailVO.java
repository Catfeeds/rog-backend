...
public class ExportClickTrainPlanDetailVO implements Serializable {
    ...
    private String examineStartEndTime;
    ...
    public String getExamineStartEndTime() {
        return examineStartEndTime;
    }

    public void setExamineStartEndTime(String examineStartEndTime) {
        this.examineStartEndTime = examineStartEndTime;
    }
    ...
    public String toString() {
        return "ClickTrainPlanDetailVO[" +
                ...
                ", examineMethodName='" + examineMethodName + '\'' +
                ", examineStartTime=" + examineStartTime +
                ", examineEndTime=" + examineEndTime +
                ", examineStartEndTime=" + examineStartEndTime +
                ", examineResult=" + examineResult +
                ", examineResultName='" + examineResultName + '\'' +
                ", measures='" + measures + '\'' +
                ", remark='" + remark + '\'' +
                ']';
    }
