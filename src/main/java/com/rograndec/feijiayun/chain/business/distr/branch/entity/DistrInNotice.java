 ...
 * 2017-10-07
 */
public class DistrInNotice implements Serializable {
    /**
     * 主键ID
     */
     ...
     * 单据类型（5413）
     */
    @ApiModelProperty(value = "单据类型（5413）")
    ...
    private List<DistrInNoticeDetail> detailList;

    public List<DistrInNoticeDetail> getDetailList() {
        return detailList;
    }

    public void setDetailList(List<DistrInNoticeDetail> detailList) {
    ...
    /**
     * 配进人员编码
     * @return storage_man_code 配进人员编码
     */
    ...
    /**
     * 配进人员名称
     * @return storage_man_name 配进人员名称
     */
     ...
     * @param distrType 配货类型（0-总部配送；3-分店间调剂；4-直调配送）
     */
    ...
    public String toString() {
        ...
        sb.append(", outboundUnitId=").append(outboundUnitId);
        sb.append(", outboundUnitCode=").append(outboundUnitCode);
        sb.append(", outboundUnitName=").append(outboundUnitName);
