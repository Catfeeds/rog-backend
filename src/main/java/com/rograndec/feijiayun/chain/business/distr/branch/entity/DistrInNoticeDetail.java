 ...
 * 2017-10-07
 */
public class DistrInNoticeDetail implements Serializable {
    /**
     * 主键ID
     */
     ...
     * 单据（配进订单）类型（5413）
     */
    @ApiModelProperty(value = "单据（配进订单）类型（5413）")
    ...
    /**
     * 单据（配进订单）类型（5413）
     * @return order_type 单据（配进订单）类型（5413）
     */
    ...
    /**
     * 单据（配进订单）类型（5413）
     * @param orderType 单据（配进订单）类型（5413）
     */
