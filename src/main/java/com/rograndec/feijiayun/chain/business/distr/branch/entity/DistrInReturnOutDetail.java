...
import com.rograndec.feijiayun.chain.business.distr.branch.vo.transfer.DistrInReturnOutDetailParam;
 ...
 * 2017-10-10
 */
public class DistrInReturnOutDetail implements Serializable {
    /**
     * 主键ID
     */
     ...
     * 单据（配进退出出库单）类型（5422）
     */
    @ApiModelProperty(value = "单据（配进退出出库单）类型（5422）")
    ...
    public static DistrInReturnOutDetail afterSaveDistrInReturnOutSetDetail(DistrInReturnOutDetail distrInReturnOutDetail,DistrInReturnOut distrInReturnOut){
        /**
         * 配进退出出库单ID
         */
         ...
         * 单据（配进退出出库单）类型（5422）
         */
        distrInReturnOutDetail.setOrderType(distrInReturnOut.getOrderType());

        /**
         * 配进退出出库单号
         */
        distrInReturnOutDetail.setOutCode(distrInReturnOut.getCode());
        distrInReturnOutDetail.setOutDate(distrInReturnOut.getOutDate());
    ...
    public static DistrInReturnOutDetail afterGenerateDistrInReturnOutSetDetail(DistrInReturnOutDetail distrInReturnOutDetail,DistrInReturnOut distrInReturnOut){


        /**
         * 基础单据ID
         */
        distrInReturnOutDetail.setBaseOrderId(distrInReturnOut.getBaseOrderId());

        /**
         * 整单折扣（%）
         */
        distrInReturnOutDetail.setWholeDiscount(distrInReturnOut.getWholeDiscount());
        ...
        BigDecimal lineDiscountAmount = CalculateComponent.getLineRoundOffByLineAmountAndWholeAmountTotal(
                ...
                , distrInReturnOutDetail.getAmount()
                , distrInReturnOut.getAmountTotal()
        );
        distrInReturnOutDetail.setLineDiscountAmount(lineDiscountAmount);
        ...
        BigDecimal realAmount = CalculateComponent.getRealAmountByQuantityAndPriceAndLineDiscount(
                distrInReturnOutDetail.getQuantity()
                , distrInReturnOutDetail.getUnitPrice()
                , distrInReturnOutDetail.getLineDiscount()
                , distrInReturnOut.getWholeDiscount()
                , distrInReturnOutDetail.getLineDiscountAmount()
        );
        distrInReturnOutDetail.setRealAmount(realAmount);
        ...
        BigDecimal realPrice = CalculateComponent.getRealPriceByRealAmountAndQuantity(
                distrInReturnOutDetail.getRealAmount()
                , distrInReturnOutDetail.getQuantity()
        );
        distrInReturnOutDetail.setRealPrice(realPrice);
        ...
        BigDecimal notaxRealAmount = CalculateComponent.getNotaxAmountByRealAmountAndTaxRate(
                distrInReturnOutDetail.getRealAmount()
                , distrInReturnOutDetail.getTaxRate()
        );
        distrInReturnOutDetail.setNotaxRealAmount(notaxRealAmount);
        ...
        BigDecimal notaxRealPrice = CalculateComponent.getNotaxPriceByNotaxAmountAndQuantity(
                distrInReturnOutDetail.getNotaxRealAmount()
                , distrInReturnOutDetail.getQuantity()
        );
        distrInReturnOutDetail.setNotaxRealPrice(notaxRealPrice);
        ...
        distrInReturnOutDetail.setTaxAmount(taxAmount);
    ...
    public static DistrInReturnOutDetail getDistrInReturnOutDetail(DistrInReturnOutDetailParam distrInReturnOutDetailParam) throws Exception {

        DistrInReturnOutDetail distrInReturnOutDetail = new DistrInReturnOutDetail();

        DistrInReturnOutDetailFormVO distrInReturnOutDetailFormVO = distrInReturnOutDetailParam.getDistrInReturnOutDetailFormVO();

        List<DistrInReturnDetail> distrInReturnDetails = distrInReturnOutDetailParam.getDistrInReturnDetails();

        UserVO userVO = distrInReturnOutDetailParam.getUserVO();

        List<GoodsTaxRate> goodsTaxRates = distrInReturnOutDetailParam.getGoodsTaxRates();

        distrInReturnOutDetail.setId(distrInReturnOutDetailFormVO.getId());
        /**
         * 企业ID
         */
        distrInReturnOutDetail.setEnterpriseId(userVO.getEnterpriseId());
        if(userVO.getChainType().equals(ChainType.Headquarters.getCode())){
            distrInReturnOutDetail.setParentId(0L);
        }else {
            distrInReturnOutDetail.setParentId(userVO.getParentId());
        }

        distrInReturnDetails.forEach( dird -> {

            if(distrInReturnOutDetailFormVO.getReturnDetailId().equals(dird.getId())){
                /**
                 * 基础单据明细ID
                 */
                distrInReturnOutDetail.setBaseOrderDtlId(dird.getId());

                /**
                 * 基础单据类型
                 */
                distrInReturnOutDetail.setBaseOrderType(dird.getOrderType());

                /**
                 * 基础单据编码
                 */
                distrInReturnOutDetail.setBaseOrderCode(dird.getInReturnCode());

                /**
                 * 基础单据日期
                 */
                distrInReturnOutDetail.setBaseOrderDate(dird.getInReturnDate());

                /**
                 * 商品ID
                 */
                distrInReturnOutDetail.setGoodsId(dird.getGoodsId());

                /**
                 * 商品编码
                 */
                distrInReturnOutDetail.setGoodsCode(dird.getGoodsCode());

                /**
                 * 条形码
                 */
                distrInReturnOutDetail.setBarcode(dird.getBarcode());

                /**
                 * 商品名称
                 */
                distrInReturnOutDetail.setGoodsName(dird.getGoodsName());

                /**
                 * 商品通用名称
                 */
                distrInReturnOutDetail.setGoodsGenericName(dird.getGoodsGenericName());

                /**
                 * 剂型ID
                 */
                distrInReturnOutDetail.setDosageId(dird.getDosageId());

                /**
                 * 剂型名称
                 */
                distrInReturnOutDetail.setDosageName(dird.getDosageName());

                /**
                 * 单位ID
                 */
                distrInReturnOutDetail.setUnitId(dird.getUnitId());

                /**
                 * 单位名称
                 */
                distrInReturnOutDetail.setUnitName(dird.getUnitName());

                /**
                 * 商品规格
                 */
                distrInReturnOutDetail.setGoodsSpecification(dird.getGoodsSpecification());

                /**
                 * 生产厂商ID
                 */
                distrInReturnOutDetail.setManufacturerId(dird.getManufacturerId());

                /**
                 * 生产厂商
                 */
                distrInReturnOutDetail.setManufacturer(dird.getManufacturer());

                /**
                 * 商品产地
                 */
                distrInReturnOutDetail.setGoodsPlace(dird.getGoodsPlace());

                /**
                 * 批准文号
                 */
                distrInReturnOutDetail.setApprovalNumber(dird.getApprovalNumber());
         ...
         * 数量
         */
        distrInReturnOutDetail.setQuantity(distrInReturnOutDetailFormVO.getQuantity());

        /**
         * 单价
         */
        distrInReturnOutDetail.setUnitPrice(distrInReturnOutDetailFormVO.getUnitPrice());

        /**
         * 行折扣（%）
         */
        distrInReturnOutDetail.setLineDiscount(distrInReturnOutDetailFormVO.getLineDiscount());
        ...
        BigDecimal amountByQuantityAndPriceAndLineDiscount = CalculateComponent.getAmountByQuantityAndPriceAndLineDiscount(
                distrInReturnOutDetailFormVO.getQuantity()
                , distrInReturnOutDetail.getUnitPrice()
                , distrInReturnOutDetail.getLineDiscount()
        );
        distrInReturnOutDetail.setAmount(amountByQuantityAndPriceAndLineDiscount);


        goodsTaxRates.forEach(gtr -> {
            if(gtr.getId().equals(distrInReturnOutDetailFormVO.getTaxRateId())){
                /**
                 * 税率ID
                 */
                distrInReturnOutDetail.setTaxRateId(gtr.getId());

                /**
                 * 税率
                 */
                distrInReturnOutDetail.setTaxRate(gtr.getTaxRate());
            }
        });
         ...
         * 未清数量
         */
        distrInReturnOutDetail.setUnclearQuantity(distrInReturnOutDetailFormVO.getQuantity());

        /**
         * 已清数量
         */
        distrInReturnOutDetail.setClearQuantity(new BigDecimal(0));

        /**
         * 行号
         */
        distrInReturnOutDetail.setLineNum(distrInReturnOutDetailFormVO.getLineNum());

        /**
         * 备注
         */
        distrInReturnOutDetail.setRemark(distrInReturnOutDetailFormVO.getRemark());

        boolean isAdd = false;

        if(distrInReturnOutDetailFormVO.getId() == null)
            isAdd = true;

        UserEnterpriseUtils.setUserCreateOrModify(distrInReturnOutDetail,userVO,isAdd);
    ...
    /**
     * 单据（配进退出出库单）类型（5422）
     * @return order_type 单据（配进退出出库单）类型（5422）
     */
    ...
    /**
     * 单据（配进退出出库单）类型（5422）
     * @param orderType 单据（配进退出出库单）类型（5422）
     */
