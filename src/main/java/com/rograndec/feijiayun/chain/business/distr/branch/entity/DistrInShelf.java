 ...
 * 2017-10-07
 */
public class DistrInShelf implements Serializable {
    /**
     * 主键ID
     */
    ...
    public static List<Long> getInStorageIds(List<DistrInShelf> distrInShelves){

        return distrInShelves.stream().map(DistrInShelf::getInId).collect(Collectors.toList());

    }

    public static List<Long> getInStorageDtlIds(List<DistrInShelf> distrInShelves){

        return distrInShelves.stream().map(DistrInShelf::getDtlId).collect(Collectors.toList());

    }

    public static List<Long> getGoodsIds(List<DistrInShelf> distrInShelves){

        Set<Long> collect = distrInShelves.stream().map(DistrInShelf::getGoodsId).collect(Collectors.toSet());
