 ...
 * 2017-10-07
 */
public class DistrReqPlanDetail implements Serializable {
    /**
     * 主键ID
     */
    ...
    /**
     * 单据（要货计划）类型（5401）
     * @return order_type 单据（要货计划）类型（5401）
     */
    ...
    /**
     * 单据（要货计划）类型（5401）
     * @param orderType 单据（要货计划）类型（5401）
     */
    ...
    /**
     * 配货机构库存可用量
     * @return org_usable_quantity 配货机构库存可用量
     */
    ...
    /**
     * 配货机构库存可用量
     * @param orgUsableQuantity 配货机构库存可用量
     */
    ...
    /**
     * 门店库存可用量
     * @return usable_quantity 门店库存可用量
     */
    ...
    public String toString() {
        ...
        sb.append(", orgUsableQuantity=").append(orgUsableQuantity);
