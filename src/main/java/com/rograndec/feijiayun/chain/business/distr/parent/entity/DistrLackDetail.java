 ...
 * 2017-10-07
 */
public class DistrLackDetail implements Serializable {
    /**
     * 主键ID
     */
     ...
     * 缺配单ID
     */
    @ApiModelProperty(value = "缺配单ID")
    private Long lackId;

    /**
     * 单据（缺配单）类型（5402）
     */
    @ApiModelProperty(value = "单据（缺配单）类型（5402）")
    private Integer orderType;

    /**
     * 缺配单单号
     */
    @ApiModelProperty(value = "缺配单单号")
    private String lackCode;

    /**
     * 缺配单日期
     */
    @ApiModelProperty(value = "缺配单日期")
    ...
    /**
     * 单据（缺配单）类型（5402）
     * @return order_type 单据（缺配单）类型（5402）
     */
    ...
    /**
     * 单据（缺配单）类型（5402）
     * @param orderType 单据（缺配单）类型（5402）
     */
    ...
    /**
     * 缺配单单号
     * @param lackCode 缺配单单号
     */
    public void setLackCode(String lackCode) {
        this.lackCode = lackCode == null ? null : lackCode.trim();
    }

    /**
     * 缺配单日期
     * @return lack_date 缺配单日期
     */
    ...
    public String toString() {
        ...
        sb.append(", lackId=").append(lackId);
        sb.append(", orderType=").append(orderType);
        sb.append(", lackCode=").append(lackCode);
        sb.append(", lackDate=").append(lackDate);
        ...
        sb.append(", requestQuantity=").append(requestQuantity);
