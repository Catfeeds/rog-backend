 ...
 * 2017-10-08
 */
public class DistrReturnCheckDetail implements Serializable {
    /**
     * 主键ID
     */
     ...
     * 单据（配后退回验收单）类型（5424）
     */
    @ApiModelProperty(value = "单据（配后退回验收单）类型（5424）")
    ...
    /**
     * 单据（配后退回验收单）类型（5424）
     * @return order_type 单据（配后退回验收单）类型（5424）
     */
    ...
    /**
     * 单据（配后退回验收单）类型（5424）
     * @param orderType 单据（配后退回验收单）类型（5424）
     */
    ...
    /**
     * 配后退回通知明细ID
     * @return notice_dtl_id 配后退回通知明细ID
     */
