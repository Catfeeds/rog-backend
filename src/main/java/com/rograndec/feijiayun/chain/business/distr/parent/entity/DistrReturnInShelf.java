 ...
 * 2017-10-08
 */
public class DistrReturnInShelf implements Serializable {
    /**
     * 主键ID
     */
    ...
    public static DistrReturnInShelf getDistrReturnInShelf(DistrReturnInShelfParam distrReturnInShelfParam) throws Exception {

        DistrReturnInShelf distrReturnInShelf = new DistrReturnInShelf();

        DistrReturnInShelfFormVO distrReturnInShelfFormVO = distrReturnInShelfParam.getDistrReturnInShelfFormVO();

        UserVO userVO = distrReturnInShelfParam.getUserVO();

        DistrReturnInDetail distrReturnInDetail = distrReturnInShelfParam.getDistrReturnInDetail();

        DistrReturnIn distrReturnIn = distrReturnInShelfParam.getDistrReturnIn();

        DistrReturnCheckLot distrReturnCheckLot = distrReturnInShelfParam.getDistrReturnCheckLot();

        WarehouseShelf warehouseShelf = distrReturnInShelfParam.getWarehouseShelf();

        /**
         * 企业ID
         */
        distrReturnInShelf.setEnterpriseId(userVO.getEnterpriseId());
        if(userVO.getChainType().equals(ChainType.Headquarters.getCode())){
            distrReturnInShelf.setParentId(0L);
        }else {
            distrReturnInShelf.setParentId(userVO.getParentId());
        }

        /**
         * 配后退回入库明细ID
         */
        distrReturnInShelf.setDtlId(distrReturnInDetail.getId());

        /**
         * 配后退回入库单ID
         */
        distrReturnInShelf.setReturnInId(distrReturnIn.getId());

        /**
         * 商品ID
         */
        distrReturnInShelf.setGoodsId(distrReturnInDetail.getGoodsId());

        /**
         * 商品编码
         */
        distrReturnInShelf.setGoodsCode(distrReturnInDetail.getGoodsCode());

        /**
         * 商品名称
         */
        distrReturnInShelf.setGoodsName(distrReturnInDetail.getGoodsName());


        /**
         * 批号
         */
        distrReturnInShelf.setLotNumber(distrReturnCheckLot.getLotNumber());

        /**
         * 生产日期
         */
        distrReturnInShelf.setProductDate(distrReturnCheckLot.getProductDate());

        /**
         * 有效期
         */
        distrReturnInShelf.setValidDate(distrReturnCheckLot.getValidDate());

        /**
         * 货位ID
         */
        distrReturnInShelf.setShelfId(warehouseShelf.getId());

        /**
         * 货位名称
         */
        distrReturnInShelf.setShelfName(warehouseShelf.getName());

        /**
         * 货位质量状态描述
         */
        distrReturnInShelf.setShelfStatusDesc(distrReturnInShelfFormVO.getJobArea() == 0 ? "合格品" : "不合格品");

        /**
         * 数量
         */
        if(distrReturnInShelfFormVO.getJobArea() == 0){
            //质量状况0-合格品，2不合格品
            distrReturnInShelf.setQuantity(distrReturnCheckLot.getQualifiedQuantity());
            /**
             * 未清数量
             */
            distrReturnInShelf.setUnclearQuantity(distrReturnCheckLot.getQualifiedQuantity());

        }else {
            distrReturnInShelf.setQuantity(distrReturnCheckLot.getUnqualifiedQuantity());
            /**
             * 未清数量
             */
            distrReturnInShelf.setUnclearQuantity(distrReturnCheckLot.getUnqualifiedQuantity());
         ...
         * 已清数量
         */
        distrReturnInShelf.setClearQuantity(new BigDecimal(0));

        /**
         * 单价
         */
        distrReturnInShelf.setUnitPrice(distrReturnInDetail.getUnitPrice());

        /**
         * 行折扣（%）
         */
        distrReturnInShelf.setLineDiscount(distrReturnInDetail.getLineDiscount());

        /**
         * 金额（整单优惠前金额）
         */
        distrReturnInShelf.setAmount(distrReturnInDetail.getAmount());

        /**
         * 整单折扣（%）
         */
        distrReturnInShelf.setWholeDiscount(distrReturnInDetail.getWholeDiscount());

        /**
         * 行优惠（整单优惠分摊到行的金额）
         */
        distrReturnInShelf.setLineDiscountAmount(distrReturnInDetail.getLineDiscountAmount());

        /**
         * 实际单价（实际金额/数量）
         */
        distrReturnInShelf.setRealPrice(distrReturnInDetail.getRealPrice());

        /**
         * 实际金额
         */
        distrReturnInShelf.setRealAmount(distrReturnInDetail.getRealAmount());

        /**
         * 税率ID
         */
        distrReturnInShelf.setTaxRateId(distrReturnInDetail.getTaxRateId());

        /**
         * 税率
         */
        distrReturnInShelf.setTaxRate(distrReturnInDetail.getTaxRate());

        /**
         * 不含税实际单价
         */
        distrReturnInShelf.setNotaxRealPrice(distrReturnInDetail.getNotaxRealPrice());

        /**
         * 不含税实际金额
         */
        distrReturnInShelf.setNotaxRealAmount(distrReturnInDetail.getNotaxRealAmount());

        /**
         * 税额
         */
        distrReturnInShelf.setTaxAmount(distrReturnInDetail.getTaxAmount());
         ...
         * 行号
         */
        distrReturnInShelf.setLineNum(distrReturnInShelfFormVO.getLineNum());
        ...
        UserEnterpriseUtils.setUserCreateOrModify(distrReturnInShelf,userVO,true);

        return distrReturnInShelf;
    }
