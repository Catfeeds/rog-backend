...
/**
 * 
 * saas_distr_return_notice_detail
 * 
 * 
 * @author dudy
 * 
 * 2017-10-07
 */
public class DistrReturnNoticeDetail implements Serializable {
    /**
     * 主键ID
     */
     ...
     * 单据（配后退回通知单）类型（5423）
     */
    @ApiModelProperty(value = "单据（配后退回通知单）类型（5423）")
    ...
    /**
     * 单据（配后退回通知单）类型（5423）
     * @return order_type 单据（配后退回通知单）类型（5423）
     */
    ...
    /**
     * 单据（配后退回通知单）类型（5423）
     * @param orderType 单据（配后退回通知单）类型（5423）
     */
