 ...
 * 2017-10-08
 */
public class DistrReturnReceiveDetail implements Serializable {
    /**
     * 主键ID
     */
     ...
     * 配后退回收货单ID
     */
    @ApiModelProperty(value = "配后退回收货单ID")
    private Long receiveId;

    /**
     * 单据（配后退回收货单）类型（5424）
     */
    @ApiModelProperty(value = "单据（配后退回收货单）类型（5424）")
    ...
    /**
     * 单据（配后退回收货单）类型（5424）
     * @return order_type 单据（配后退回收货单）类型（5424）
     */
    ...
    /**
     * 单据（配后退回收货单）类型（5424）
     * @param orderType 单据（配后退回收货单）类型（5424）
     */
