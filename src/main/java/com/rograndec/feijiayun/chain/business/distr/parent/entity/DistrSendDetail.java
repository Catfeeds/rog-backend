...
import com.rograndec.feijiayun.chain.business.distr.parent.vo.SaveDistrOutShelfVO;
import io.swagger.annotations.ApiModelProperty;
 
/**
 * 
 * saas_distr_send_detail
 * 
 * 
 * @author lanxj
 * 
 * 2017-10-08
 */
public class DistrSendDetail implements Serializable {
    /**
     * 主键ID
     */
     ...
     * 配货单ID
     */
    @ApiModelProperty(value = "配货单ID")
    private Long distrId;

    /**
     * 单据（配货单）类型（5411）
     */
    @ApiModelProperty(value = "单据（配货单）类型（5411）")
     ...
     * 分店库存可用量
     */
    @ApiModelProperty(value = "分店库存可用量")
    ...
    /**
     * 单据（配货单）类型（5411）
     * @return order_type 单据（配货单）类型（5411）
     */
    ...
    /**
     * 单据（配货单）类型（5411）
     * @param orderType 单据（配货单）类型（5411）
     */
    ...
    /**
     * 配货单单号
     * @param distrCode 配货单单号
     */
    public void setDistrCode(String distrCode) {
        this.distrCode = distrCode == null ? null : distrCode.trim();
    }
    ...
    /**
     * 总部库存可用量
     * @return parent_usable_quantity 总部库存可用量
     */
    ...
    /**
     * 总部库存可用量
     * @param parentUsableQuantity 总部库存可用量
     */
    ...
    /**
     * 分店库存可用量
     * @return usable_quantity 分店库存可用量
     */
    ...
    public String toString() {
        ...
        sb.append(", distrId=").append(distrId);
        sb.append(", orderType=").append(orderType);
        sb.append(", distrCode=").append(distrCode);
        ...
        sb.append(", parentUsableQuantity=").append(parentUsableQuantity);
