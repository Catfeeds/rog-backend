...
public class PickDetail implements Serializable {
     ...
     * 单据类型（5322）
     */
    @ApiModelProperty(value = "单据类型（5322）")
    ...
    private List<PickShelf> pickShelves = new ArrayList<>();
    /**
     * saas_pick_detail
     */
    ...
    public String toString() {
        ...
        sb.append(", pickId=").append(pickId);
        sb.append(", orderType=").append(orderType);
        sb.append(", pickCode=").append(pickCode);
    ...
    public List<PickShelf> getPickShelves() {
        return pickShelves;
    }

    public void setPickShelves(List<PickShelf> pickShelves) {
        this.pickShelves = pickShelves;
    }
}