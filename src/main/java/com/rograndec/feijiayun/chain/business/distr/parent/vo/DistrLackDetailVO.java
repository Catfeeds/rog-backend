...
import javax.validation.constraints.NotNull;
 ...
 /**
 * 
 * @ClassName: DistrLackDetailVO
 * @Description:  总部-配货出库-缺配单明细
 * @author zhengbin.jin
 * @version 1.0 
 * @date 2017-10-07 15:59:05
 */
@ApiModel(value = "DistrLackDetailVO", description = "总部-配货出库-缺配单明细")
public class DistrLackDetailVO implements Serializable {
