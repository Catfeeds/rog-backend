...
import java.util.Date;
 ...
 /**
 * 
 * @ClassName: DistrLackSaveOrupdateVO
 * @Description:  总部-配货出库-缺配单-Rest接口
 * @author zhengbin.jin
 * @version 1.0 
 * @date 2017-10-07 15:58:51
 */
@ApiModel(value = "DistrLackSaveOrupdateVO", description = "总部-配货出库-缺配单")
public class DistrLackSaveOrupdateVO implements Serializable {
     ...
     * 单据类型（5402）
     */
	@NotNull(message="单据类型（5402）不能为空!")
	...
	@NotNull(message="配货类型（0-总部配送；3-分店间调剂；4-直调配送）不能为空!")
