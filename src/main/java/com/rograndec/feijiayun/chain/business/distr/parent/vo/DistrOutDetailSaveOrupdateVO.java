...
import javax.validation.constraints.NotNull;
 ...
 /**
 * 
 * @ClassName: DistrOutDetailSaveOrupdateVO
 * @Description:  总部-配货出库-配货出库明细-Rest接口
 * @author zhengbin.jin
 * @version 1.0 
 * @date 2017-10-07 15:58:09
 */
@ApiModel(value = "DistrOutDetailSaveOrupdateVO", description = "总部-配货出库-配货出库明细")
public class DistrOutDetailSaveOrupdateVO implements Serializable {
     ...
     * 单据（配货出库单）类型（5412）
     */
	@NotNull(message="单据（配货出库单）类型（5412）不能为空!")
