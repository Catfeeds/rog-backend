...
import javax.validation.constraints.NotNull;
 ...
 /**
 * 
 * @ClassName: DistrOutShelfVO
 * @Description:  总部-配货出库-配货出库货位明细
 * @author zhengbin.jin
 * @version 1.0 
 * @date 2017-10-07 15:58:23
 */
@ApiModel(value = "DistrOutShelfVO", description = "总部-配货出库-配货出库货位明细")
public class DistrOutShelfVO implements Serializable {
