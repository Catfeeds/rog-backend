...
public class SaleCommission implements Serializable {
    ...
    public static SaleCommission genreateSaleCommission(UserVO userVO , NoSaleCommissionResponseTotalVO commissionVO,String code,boolean isAdd) throws Exception {
         ...
         */
        if(!isAdd)
            saleCommission.setId(commissionVO.getId());

        /**
         * 企业ID
         */
        saleCommission.setEnterpriseId(userVO.getEnterpriseId());

        /**
         * 上级企业ID
         */
        saleCommission.setParentId(userVO.getParentId());

        /**
         * 门店id
         */
        saleCommission.setBranchId(commissionVO.getBranchId());

        /**
         * 门店编码
         */
        saleCommission.setBranchCode(commissionVO.getBranchCode());

        /**
         * 门店名称
         */
        saleCommission.setBranchName(commissionVO.getBranchName());


        /**
         * 单据类型（6243）
         */
        saleCommission.setOrderType(OrderRule.COMMISSION.getType());

        /**
         * 单据编码
         */
        saleCommission.setCode(code);

        /**
         * 提成日期
         */
        saleCommission.setCommissionDate(commissionVO.getCommissionDate());

        /**
         * 提成人员ID
         */
        saleCommission.setCommissionManId(commissionVO.getCommissionManId());

        /**
         * 提成人员编码
         */
        saleCommission.setCommissionManCode(commissionVO.getCommissionManCode());

        /**
         * 提成人员名称
         */
        saleCommission.setCommissionManName(commissionVO.getCommissionManName());

        /**
         * 营业人员ID
         */
        saleCommission.setClerkId(commissionVO.getClerkId());

        /**
         * 营业人员编码
         */
        saleCommission.setClerkCode(commissionVO.getClerkCode());

        /**
         * 营业人员名称
         */
        saleCommission.setClerkName(commissionVO.getClerkName());

        /**
         * 销售日期从
         */
        saleCommission.setSaleDateFrom(commissionVO.getSaleDateFrom());

        /**
         * 销售日期至
         */
        saleCommission.setSaleDateTo(commissionVO.getSaleDateTo());

        /**
         * 应提金额合计
         */
        saleCommission.setAmountTotal(commissionVO.getAmountTotal());

        /**
         * 实提金额合计
         */
        saleCommission.setRealAmountTotal(commissionVO.getRealAmountTotal());

        /**
         * 差异金额合计
         */
        saleCommission.setDiffAmountTotal(commissionVO.getAmountTotal().subtract(commissionVO.getRealAmountTotal()).setScale(2,BigDecimal.ROUND_HALF_UP));

        /**
         * 状态（1-已完成；2-已冲销）
         */
        saleCommission.setStatus(SaleCommissionStatus.OVER);

        /**
         * 备注
         */
        saleCommission.setRemark(commissionVO.getRemark());


        UserEnterpriseUtils.setUserCreateOrModify(saleCommission,userVO,isAdd);
