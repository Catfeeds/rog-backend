 ...
 */
@ApiModel
public class PaymentInvoiceQueryParamVO implements Serializable {
    /**
     * 供货单位编码
     */
    ...
    public PaymentInvoiceQueryParamVO() {
    }

    public PaymentInvoiceQueryParamVO(String supplierCode, String supplierName, String code, String billManName, Integer status, String orderName, String orderType, String startDate, String endDate) {
