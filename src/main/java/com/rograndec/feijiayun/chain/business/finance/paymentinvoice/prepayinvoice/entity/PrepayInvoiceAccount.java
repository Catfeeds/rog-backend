 ...
 * 2018-01-10
 */
public class PrepayInvoiceAccount implements Serializable {
    /**
     * 主键ID
     */
     ...
     * 预付发票ID
     */
    @ApiModelProperty(value = "预付发票ID")
    private Long invoiceId;

    /**
     * 预付发票明细ID
     */
    @ApiModelProperty(value = "预付发票明细ID")
     ...
     * 入库商品明细ID
     */
    @ApiModelProperty(value = "入库商品明细ID")
    private Long baseDtlId;

    /**
     * 入库货位明细ID
     */
    @ApiModelProperty(value = "入库货位明细ID")
    ...
    public static PrepayInvoiceAccount getPrepayInvoiceAccount(UserVO userVO,
                                                               Long prepayInvoiceId,
                                                               Long prepayInvoiceDetailId,
                                                               Long inStoreId,
                                                               String inStoreCode,
                                                               Integer inStoreOrderType,
                                                               Date inStoreOrderDate,
                                                               Long inStoreDetailId,
                                                               Long inStoreShelfId,
                                                               BigDecimal accountQuantity,
                                                               BigDecimal accountAmount,
                                                               BigDecimal accountNotaxAmount,
                                                               BigDecimal accountTaxAmount,
                                                               Integer lineNum,
                                                               Integer accountStatus,
                                                               BigDecimal diffAmount,
                                                               BigDecimal diffNotaxAmount,
                                                               BigDecimal diffTaxAmount,
                                                               String remark
    ) throws Exception {

        PrepayInvoiceAccount prepayInvoiceAccount = new PrepayInvoiceAccount();
        /**
         * 企业ID
         */
        prepayInvoiceAccount.setEnterpriseId(userVO.getEnterpriseId());

        /**
         * 上级企业ID
         */
        prepayInvoiceAccount.setParentId(userVO.getParentId());

        /**
         * 预付发票ID
         */
        prepayInvoiceAccount.setInvoiceId(prepayInvoiceId);

        /**
         * 预付发票明细ID
         */
        prepayInvoiceAccount.setInvoiceDtlId(prepayInvoiceDetailId);

        /**
         * 入库单ID
         */
        prepayInvoiceAccount.setBaseOrderId(inStoreId);

        /**
         * 入库单编码
         */
        prepayInvoiceAccount.setBaseOrderCode(inStoreCode);

        /**
         * 入库类型
         */
        prepayInvoiceAccount.setBaseOrderType(inStoreOrderType);

        /**
         * 入库日期
         */
        prepayInvoiceAccount.setBaseOrderDate(inStoreOrderDate);

        /**
         * 入库商品明细ID
         */
        prepayInvoiceAccount.setBaseDtlId(inStoreDetailId);

        /**
         * 入库货位明细ID
         */
        prepayInvoiceAccount.setBaseShelfDtlId(inStoreShelfId);

        /**
         * 本次对账数量
         */
        prepayInvoiceAccount.setAccountQuantity(accountQuantity);

        /**
         * 本次对账金额
         */
        prepayInvoiceAccount.setAccountAmount(accountAmount);

        /**
         * 本次对账不含税金额
         */
        prepayInvoiceAccount.setAccountNotaxAmount(accountNotaxAmount);

        /**
         * 本次对账税额
         */
        prepayInvoiceAccount.setAccountTaxAmount(accountTaxAmount);

        /**
         * 行号
         */
        prepayInvoiceAccount.setLineNum(lineNum);

        /**
         * 状态
         */
        prepayInvoiceAccount.setStatus(accountStatus);

        /**
         * 备注
         */
        prepayInvoiceAccount.setRemark(remark);

        /**
         * 金额差额
         */
        prepayInvoiceAccount.setDiffAmount(diffAmount);

        /**
         * 不含税金额差额
         */
        prepayInvoiceAccount.setDiffNotaxAmount(diffNotaxAmount);

        /**
         * 税额差额
         */
        prepayInvoiceAccount.setDiffTaxAmount(diffTaxAmount);

        UserEnterpriseUtils.setUserCreateOrModify(prepayInvoiceAccount,userVO,true);

        return prepayInvoiceAccount;
    ...
    /**
     * 预付发票明细ID
     * @return invoice_dtl_id 预付发票明细ID
     */
    ...
    /**
     * 入库货位明细ID
     * @return base_shelf_dtl_id 入库货位明细ID
     */
