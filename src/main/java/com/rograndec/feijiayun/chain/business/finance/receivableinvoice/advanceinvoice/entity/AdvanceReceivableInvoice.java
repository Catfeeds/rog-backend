 ...
 * 2018-01-05
 */
public class AdvanceReceivableInvoice implements Serializable {
    /**
     * 主键ID
     */
     ...
     * 单据类型（2301）
     */
    @ApiModelProperty(value = "单据类型（2301）")
    ...
    /**
     * 0-总部；1-自营店；2-加盟店；3-供货单位；4-购货单位；5-税率
     */
    ...
    private List<AdvanceReceivableInvoiceDetail> aridvList;
    
    /**
     * 发票开票信息
     */
    @ApiModelProperty(value = "发票开票信息")
    private AdvanceReceivableInvoiceInfo advanceReceivableInvoiceInfoVo;
    /**
     * 主键ID
     * @return id 主键ID
     */
	...
	public List<AdvanceReceivableInvoiceDetail> getAridvList() {
		return aridvList;
	}

	public void setAridvList(List<AdvanceReceivableInvoiceDetail> aridvList) {
		this.aridvList = aridvList;
	}

	public AdvanceReceivableInvoiceInfo getAdvanceReceivableInvoiceInfoVo() {
		return advanceReceivableInvoiceInfoVo;
	}

	public void setAdvanceReceivableInvoiceInfoVo(AdvanceReceivableInvoiceInfo advanceReceivableInvoiceInfoVo) {
