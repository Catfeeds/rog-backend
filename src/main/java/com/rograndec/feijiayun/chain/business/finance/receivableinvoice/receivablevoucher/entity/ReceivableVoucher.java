package com.rograndec.feijiayun.chain.business.finance.receivableinvoice.receivablevoucher.entity;
 ...
 * 2018-01-05
 */
public class ReceivableVoucher implements Serializable {
    /**
     * 主键ID
     */
     ...
     * 单据类型（2303）
     */
    @ApiModelProperty(value = "单据类型（2303）")
