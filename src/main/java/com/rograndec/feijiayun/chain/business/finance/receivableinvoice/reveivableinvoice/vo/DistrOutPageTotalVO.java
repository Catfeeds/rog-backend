...
public class DistrOutPageTotalVO implements Serializable {
    ...
    List<DistrOutPageVO> distrOutPageVO;
    ...
    public List<DistrOutPageVO> getDistrOutPageVO() {
        return distrOutPageVO;
    }

    public void setDistrOutPageVO(List<DistrOutPageVO> distrOutPageVO) {
        this.distrOutPageVO = distrOutPageVO;
    }
