...
public class SaveReceivableInvoiceDetailVO implements Serializable {

    /**
     * 应收发票明细表主键ID
     */
    @ApiModelProperty(value = "应收发票明细表主键ID(更新时必传字段)")
    private Long id;
     ...
     * 数量
     */
    @ApiModelProperty(value = "数量(新增必传)")
    private BigDecimal quantity;

    /**
     * 单价
     */
    @ApiModelProperty(value = "单价(新增必传)")
     ...
     * 税率ID
     */
    @ApiModelProperty(value = "税率ID(新增必传)")
