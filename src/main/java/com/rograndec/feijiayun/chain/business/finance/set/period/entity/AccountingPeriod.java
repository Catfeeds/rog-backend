...
public class AccountingPeriod implements Serializable {
    ...
    public static List<Long> getIds(List<AccountingPeriod> accountingPeriods){

        return accountingPeriods.stream().map(accountingPeriod -> accountingPeriod.getId()).collect(Collectors.toList());
    }
