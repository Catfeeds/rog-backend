...
public class AccountingPeriodVO implements Serializable {
    ...
    private List<AccountingPeriodDetailVO> detailList;
	...
	public List<AccountingPeriodDetailVO> getDetailList() {
		return detailList;
	}

	public void setDetailList(List<AccountingPeriodDetailVO> detailList) {
