...
public class SpecialGoods implements Serializable {
    ...
    /**
     * 专管药品（0-含特殊药品复方制剂；1-蛋白同化制剂；2-肽类激素）
     * @return special_goods 专管药品（0-含特殊药品复方制剂；1-蛋白同化制剂；2-肽类激素）
     */
    ...
    /**
     * 专管药品（0-含特殊药品复方制剂；1-蛋白同化制剂；2-肽类激素）
     * @param specialGoods 专管药品（0-含特殊药品复方制剂；1-蛋白同化制剂；2-肽类激素）
     */
    ...
    /**
     * 限售数量
     * @return limit_sale_quantity 限售数量
     */
    ...
    public String toString() {
        ...
        sb.append(", specialGoods=").append(specialGoods);
        ...
        sb.append(", limitSaleQuantity=").append(limitSaleQuantity);
        ...
        sb.append(", formulationType=").append(formulationType);
