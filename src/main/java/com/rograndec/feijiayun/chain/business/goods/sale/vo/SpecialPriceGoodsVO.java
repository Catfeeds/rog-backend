...
public class SpecialPriceGoodsVO implements Serializable {
    ...
    /**
     * 保存发现重复时是否修改 默认为false
     */
    private Boolean isUpdate = new Boolean(false);
    ...
    public boolean equals(Object o) {
        ...
        SpecialPriceGoodsVO that = (SpecialPriceGoodsVO) o;
