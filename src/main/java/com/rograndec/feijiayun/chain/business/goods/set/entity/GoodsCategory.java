...
public class GoodsCategory implements Serializable {
    ...
    /**
     * 上级分类ID
     * @return parent_category_id 上级分类ID
     */
    ...
    /**
     * 商品大类（0-药品；1-食品；2-化妆品；3-医疗器械；4-其它）
     * @return type 商品大类（0-药品；1-食品；2-化妆品；3-医疗器械；4-其它）
     */
    ...
    /**
     * 商品大类（0-药品；1-食品；2-化妆品；3-医疗器械；4-其它）
     * @param type 商品大类（0-药品；1-食品；2-化妆品；3-医疗器械；4-其它）
     */
