 ...
 * 2017-10-14
 */
public class IntegralExchangeDtl implements Serializable {
    /**
     * 主键ID
     */
     ...
     * 积分兑换品种ID
     */
    @ApiModelProperty(value = "积分兑换品种ID")
    ...
    private List<IntegralExchangeShelf> exchangeShelfList;

    public List<IntegralExchangeShelf> getExchangeShelfList() {
        return exchangeShelfList;
    }

    public void setExchangeShelfList(List<IntegralExchangeShelf> exchangeShelfList) {
        this.exchangeShelfList = exchangeShelfList;
    }
    ...
    /**
     * 积分兑换品种ID
     * @return exchange_goods_id 积分兑换品种ID
     */
    ...
    /**
     * 积分兑换品种ID
     * @param exchangeGoodsId 积分兑换品种ID
     */
    ...
    public String toString() {
        ...
        sb.append(", exchangeGoodsId=").append(exchangeGoodsId);
        ...
        sb.append(", integralExchange=").append(integralExchange);
        sb.append(", useableQuantity=").append(useableQuantity);
