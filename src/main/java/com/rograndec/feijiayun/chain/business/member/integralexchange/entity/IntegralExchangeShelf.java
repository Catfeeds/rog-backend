 ...
 * 2017-10-14
 */
public class IntegralExchangeShelf implements Serializable {
    /**
     * 主键ID
     */
     ...
     * 积分兑换明细ID
     */
    @ApiModelProperty(value = "积分兑换明细ID")
    private Long dtlId;
