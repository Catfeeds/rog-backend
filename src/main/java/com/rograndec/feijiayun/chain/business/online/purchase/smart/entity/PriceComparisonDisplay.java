 ...
 * 2017-11-22
 */
public class PriceComparisonDisplay implements Serializable {
    /**
     * ID
     */
     ...
     * 全网比价是否可用0-不可用，可用
     */
    @ApiModelProperty(value = "全网比价是否可用0-不可用，可用")
    ...
    /**
     * 全网比价是否可用0-不可用，可用
     * @return status 全网比价是否可用0-不可用，可用
     */
