...
public class AddInstorageVO implements Serializable{
...
//	@NotNull(message="配进入库日期不能为空！")
	...
	//入库明细
	@Valid
	private List<AddInstorageDtlVO> addInstorageDtlVOList;
	
	//配送信息
	@Valid
	private AddInstorageOtherVO addInstorageOtherVO;
	...
	public static AddInstorageVO getAddInstorageVO(DistrOut distrOut, DistrInReturnOut distrInReturnOut, Enterprise enterprise,Long distrManId){

		AddInstorageVO addInstorageVO = new AddInstorageVO();

		addInstorageVO.setDistrType(distrOut.getDistrType());

		addInstorageVO.setOrderDate(new Date());

		addInstorageVO.setOutboundUnitId(distrInReturnOut.getEnterpriseId());
		addInstorageVO.setOutboundUnitCode(enterprise.getCode());
		addInstorageVO.setOutboundUnitName(enterprise.getName());
		addInstorageVO.setNoticeStorageManId(distrManId);

		addInstorageVO.setQuantityTotal(distrOut.getQuantityTotal());
		addInstorageVO.setVarietiesQuantity(distrOut.getVarietiesQuantity());

		//金额合计
		addInstorageVO.setAmountTotal(distrOut.getAmountTotal());
		//整单折扣
		addInstorageVO.setWholeDiscount(distrOut.getWholeDiscount());
		//整单优惠金额
		addInstorageVO.setWholeDiscountAmount(distrOut.getWholeDiscountAmount());
		//实际金额合计
		addInstorageVO.setRealAmountTotal(distrOut.getRealAmountTotal());
		//不含税金额合计
		addInstorageVO.setNotaxRealAmountTotal(distrOut.getNotaxRealAmountTotal());
		//税额合计
		addInstorageVO.setTaxAmountTotal(distrOut.getTaxAmountTotal());
		...
		for(DistrOutDetail distrOutDetail : distrOutDetailList){
			...
			addInstorageDtlVO.setGoodsId(distrOutDetail.getGoodsId());

			addInstorageDtlVO.setQuantity(distrOutDetail.getQuantity());

			addInstorageDtlVO.setUnitPrice(distrOutDetail.getUnitPrice());
			addInstorageDtlVO.setLineDiscount(distrOutDetail.getLineDiscount());

			addInstorageDtlVO.setAmount(distrOutDetail.getAmount());
			addInstorageDtlVO.setWholeDiscount(distrOutDetail.getWholeDiscount());
			addInstorageDtlVO.setLineDiscountAmount(distrOutDetail.getLineDiscountAmount());
			addInstorageDtlVO.setRealPrice(distrOutDetail.getUnitPrice());
			addInstorageDtlVO.setRealAmount(distrOutDetail.getRealAmount());
			addInstorageDtlVO.setTaxAmount(distrOutDetail.getTaxAmount());
			addInstorageDtlVO.setTaxRateId(distrOutDetail.getTaxRateId());

			addInstorageDtlVO.setNotaxRealAmount(distrOutDetail.getNotaxRealAmount());
			addInstorageDtlVO.setNotaxRealPrice(distrOutDetail.getNotaxRealPrice());
	...
	public List<AddInstorageDtlVO> getAddInstorageDtlVOList() {
		return addInstorageDtlVOList;
	}

	public void setAddInstorageDtlVOList(List<AddInstorageDtlVO> addInstorageDtlVOList) {
		this.addInstorageDtlVOList = addInstorageDtlVOList;
	}

	public AddInstorageOtherVO getAddInstorageOtherVO() {
		return addInstorageOtherVO;
	}

	public void setAddInstorageOtherVO(AddInstorageOtherVO addInstorageOtherVO) {
		this.addInstorageOtherVO = addInstorageOtherVO;
	}
