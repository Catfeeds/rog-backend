...
public class PurchaseCheckDetail implements Serializable {
    /**
     * 主键ID
     */
    private Long id;
    ...
    List<PurchaseCheckLot> purchaseCheckLotList;
    ...
    /**
     * 采购订单明细ID
     * @return purchase_order_dtl_id 采购订单明细ID
     */
    ...
    /**
     * 采购订单明细ID
     * @param purchaseOrderDtlId 采购订单明细ID
     */
    public void setPurchaseOrderDtlId(Long purchaseOrderDtlId) {
        this.purchaseOrderDtlId = purchaseOrderDtlId;
    }

    public List<PurchaseCheckLot> getPurchaseCheckLotList() {
        return purchaseCheckLotList;
    }

    public void setPurchaseCheckLotList(List<PurchaseCheckLot> purchaseCheckLotList) {
        this.purchaseCheckLotList = purchaseCheckLotList;
    }
    ...
    public String toString() {
        ...
        sb.append(", purchaseOrderDtlId=").append(purchaseOrderDtlId);
