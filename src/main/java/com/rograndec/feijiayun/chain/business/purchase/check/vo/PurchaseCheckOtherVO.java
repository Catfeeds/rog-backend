...
public class PurchaseCheckOtherVO implements Serializable {
     ...
     * 运输方式ID
     */
    @ApiModelProperty(required = true, value = "运输方式ID")
     ...
     * 温控方式ID
     */
    @ApiModelProperty(required = true, value = "温控方式ID")
    private Integer tempControlModeId;
     ...
     * 承运方式ID
     */
    @ApiModelProperty(required = true, value = "承运方式ID")
     ...
     * 全程温湿度数据名字
     */
    @ApiModelProperty(required = true, value = "全程温湿度数据名字")
    ...
    public Integer getTempControlModeId() {
        return tempControlModeId;
    }

    public void setTempControlModeId(Integer tempControlModeId) {
        this.tempControlModeId = tempControlModeId;
    }
    ...
    public String toString() {
        ...
        sb.append(", transportModeId=").append(transportModeId);
        sb.append(", tempControlModeId=").append(tempControlModeId);
        sb.append(", carriageModeId=").append(carriageModeId);
