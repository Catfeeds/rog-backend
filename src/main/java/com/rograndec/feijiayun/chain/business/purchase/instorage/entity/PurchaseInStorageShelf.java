...
public class PurchaseInStorageShelf implements Serializable {
    /**
     * 主键ID
     */
    private Long id;
    ...
    public static List<Long> getInStorageIds(List<PurchaseInStorageShelf> purchaseInStorageShelves){

        return purchaseInStorageShelves.stream().map(PurchaseInStorageShelf::getInStorageId).collect(Collectors.toList());

    }

    public static List<Long> getInStorageDtlIds(List<PurchaseInStorageShelf> purchaseInStorageShelves){

        return purchaseInStorageShelves.stream().map(PurchaseInStorageShelf::getInStorageDtlId).collect(Collectors.toList());

    }

    public static List<Long> getGoodsIds(List<PurchaseInStorageShelf> purchaseInStorageShelves){

        Set<Long> collect = purchaseInStorageShelves.stream().map(PurchaseInStorageShelf::getGoodsId).collect(Collectors.toSet());
    ...
    /**
     * 入库明细单ID
     * @return in_storage_dtl_id 入库明细单ID
     */
    public Long getInStorageDtlId() {
        return inStorageDtlId;
    }

    /**
     * 入库明细单ID
     * @param inStorageDtlId 入库明细单ID
     */
    public void setInStorageDtlId(Long inStorageDtlId) {
        this.inStorageDtlId = inStorageDtlId;
    }
    ...
    public String toString() {
        ...
        sb.append(", inStorageDtlId=").append(inStorageDtlId);
