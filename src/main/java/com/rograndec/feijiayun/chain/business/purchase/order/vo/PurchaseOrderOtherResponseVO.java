...
public class PurchaseOrderOtherResponseVO implements Serializable {
    /**
     * 主键ID
     */
    ...
    private String account;
	  /**
	     * 收货人员
	     * */
	  @ApiModelProperty(value = "收货人员该字段暂时不用")
	    private String receiver;
	    /**
	     * 收货单位
	     */
	  @ApiModelProperty(value = "收货单位该字段暂时不用")
    ...
    /**
     * 配送类型（0-总部配送；1-委托运输；2-自提）
     */
	  @ApiModelProperty(value = "配送类型（0-总部配送；1-委托运输；2-自提）")
