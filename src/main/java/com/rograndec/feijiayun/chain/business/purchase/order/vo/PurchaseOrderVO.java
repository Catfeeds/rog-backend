...
public class PurchaseOrderVO implements Serializable {
     ...
     * 订单类型（5211）
     */
	@ApiModelProperty(value = "订单类型（5211）")
    private Integer orderType;

    /**
     * 采购方式（0-MPH采购；1-标准采购）
     */
	@ApiModelProperty(value = " 采购方式（0-MPH采购；1-标准采购）")
     ...
     * 收货标志（0-未收获；1-已收货）
     */
	@ApiModelProperty(value = "收货标志（0-未收获；1-已收货）")
    ...
    private List<PurchaseOrderDetailVO> purchaseOrderDetailVO;
    /**
     * 采购订单配送和结算
     * */
    ...
    public List<PurchaseOrderDetailVO> getPurchaseOrderDetailVO() {
		return purchaseOrderDetailVO;
	}

	public void setPurchaseOrderDetailVO(List<PurchaseOrderDetailVO> purchaseOrderDetailVO) {
		this.purchaseOrderDetailVO = purchaseOrderDetailVO;
	}
