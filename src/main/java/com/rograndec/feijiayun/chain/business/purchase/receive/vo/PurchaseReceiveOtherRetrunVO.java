...
public class PurchaseReceiveOtherRetrunVO implements Serializable {
    ...
    /**
     * 配货类型（0-配送；1-委托运输；2-自提；3-直配）
     * @return carriage_mode 配货类型（0-配送；1-委托运输；2-自提；3-直配）
     */
    ...
    /**
     * 配货类型（0-配送；1-委托运输；2-自提；3-直配）
     * @param carriageMode 配货类型（0-配送；1-委托运输；2-自提；3-直配）
     */
