...
public class PurchaseReturnOutDetail implements Serializable {
     ...
     * 单据（购进退出出库单）类型（5214）
     */
    @ApiModelProperty(value = "单据（购进退出出库单）类型（5214）")
    ...
    /**
     * 单据（购进退出出库单）类型（5214）
     * @return order_type 单据（购进退出出库单）类型（5214）
     */
    ...
    /**
     * 单据（购进退出出库单）类型（5214）
     * @param orderType 单据（购进退出出库单）类型（5214）
     */
