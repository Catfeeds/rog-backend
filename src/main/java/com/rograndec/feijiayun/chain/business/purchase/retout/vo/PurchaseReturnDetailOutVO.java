...
public class PurchaseReturnDetailOutVO implements Serializable {
    ...
    private Long id;
    @ApiModelProperty(value = "采购入库明细ID,只有勾选采购入库才会传值")
     ...
     * 状态
     */
    @ApiModelProperty(value = "状态(81-待出库;83-待复核;91-待开票;92-已开票（待支付）)")
