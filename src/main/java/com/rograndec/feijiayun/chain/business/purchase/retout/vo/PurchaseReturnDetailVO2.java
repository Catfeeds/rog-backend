...
public class PurchaseReturnDetailVO2 implements Serializable {
    ...
    private  List<PurchaseReturnOutShelfVO> returnOutShelfVOList;
    ...
    public List<PurchaseReturnOutShelfVO> getReturnOutShelfVOList() {
        return returnOutShelfVOList;
    }

    public void setReturnOutShelfVOList(List<PurchaseReturnOutShelfVO> returnOutShelfVOList) {
        this.returnOutShelfVOList = returnOutShelfVOList;
    }
