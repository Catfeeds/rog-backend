...
/**
 * 
 * @ClassName: BaseGoodsRequestPageParamVO   
 * @Description: 报表公共商品参数带分页
 * @author yuting.li
 * @version 1.0 
 * @date 2017年10月23日 上午11:30:14
 */
@ApiModel(value = "BaseGoodsRequestPageParamVO", description = "商品请求参数")
public class BaseGoodsRequestPageParamVO extends PageVO implements Serializable{
