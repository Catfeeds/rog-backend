...
public class FinanceDetailDtlResultPrintVO implements Serializable{
	...
	private List<FinanceDetailDtlResultVO> resultList;
	
	public FinanceDetailDtlResultPrintVO(String orderDate) {
		super();
	...
	public List<FinanceDetailDtlResultVO> getResultList() {
		return resultList;
	}

	public void setResultList(List<FinanceDetailDtlResultVO> resultList) {
