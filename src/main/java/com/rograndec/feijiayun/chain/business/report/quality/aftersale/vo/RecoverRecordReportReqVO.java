...
public class RecoverRecordReportReqVO  extends BaseGoodsRequestParam{
    ...
    @ApiModelProperty("追回日期(从)")
    private String startDate;

    @ApiModelProperty("追回日期(至)")
    ...
    @ApiModelProperty("追回单号")
    private String code;

    @ApiModelProperty("追回负责人")
