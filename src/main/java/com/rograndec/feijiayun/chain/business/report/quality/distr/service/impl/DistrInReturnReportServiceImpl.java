 ...
 */
@Service
public class DistrInReturnReportServiceImpl implements DistrInReturnReportService {
    ...
    @Override
    public void getInReturnGoodsList(Page<InReturnTotalVO> page, RequestGetInReturnParamVO getReturnParamVO, UserVO userVO) {
        com.github.pagehelper.Page<Object> objects = PageHelper.startPage(page.getPageNo(), page.getPageSize());
        Long enterpriseId = userVO.getEnterpriseId();
        InReturnTotalVO returnTotalVO = getInReturnTotalVO(getReturnParamVO, enterpriseId);
    ...
    @Override
    public void exportInReturnGoodsList(OutputStream output, UserVO userVO, RequestGetInReturnParamVO paramForListVO) throws Exception {
        Long enterpriseId = userVO.getEnterpriseId();
        InReturnTotalVO returnTotalVO = getInReturnTotalVO(paramForListVO, enterpriseId);

        List<InReturnGoodsReportVO> returnGoodsReportVOList = returnTotalVO.getInReturnGoodsReportVOS();
        String firstTitle = userVO.getEnterpriseName();
        String secondTitle = "配进退出单";
        LinkedHashMap<String,String> headerHashMap = new LinkedHashMap<>();
        headerHashMap.put("inReturnDate","日期");
    ...
    private InReturnTotalVO getInReturnTotalVO(RequestGetInReturnParamVO getReturnParamVO, Long enterpriseId) {

        List<InReturnGoodsReportVO> inReturnGoodsReportVOS = goodsMapper.getInReturnGoodsReport(getReturnParamVO, enterpriseId);
        //        数量合计
        ...
        for (InReturnGoodsReportVO item : inReturnGoodsReportVOS) {
...
//            }
        ...
        InReturnTotalVO returnTotalVO = new InReturnTotalVO();
        ...
        returnTotalVO.setInReturnGoodsReportVOS(inReturnGoodsReportVOS);
