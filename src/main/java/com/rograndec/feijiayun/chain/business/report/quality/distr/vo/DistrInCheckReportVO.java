 ...
 */
public class DistrInCheckReportVO implements Serializable {
    /**
     */
     ...
     * 第二验收人员ID
     */
    @ApiModelProperty(value = "验收人员2 ID")
  ...
  /**配货单号,配进订单单号为上上级的的单号，这期不做   * */
    ...
    private String distrInNoticeCode;
   ...
   */
   ...
   private String qualityPeriodUnit="";
	...
	public String getDistrInNoticeCode() {
		return distrInNoticeCode;
	}

	public void setDistrInNoticeCode(String distrInNoticeCode) {
		this.distrInNoticeCode = distrInNoticeCode;
	}
