 ...
 */
@ApiModel
public class DistrReturnNoticeReportVO implements Serializable {
    /**
     */
   ...
   */
   ...
   private String qualityPeriodUnit="";
	...
	public String getDistrInReturn() {
		return distrInReturn;
	}

	public void setDistrInReturn(String distrInReturn) {
