...
@ApiModel(value = "RequestDistrReqPlan", description = "配进收货请求参数")
public class RequestDistrInReceive extends BaseGoodsRequestParam{
	...
	@ApiModelProperty(value = "状态:30-待收货,31-待验收（已收货）,32-待入库（已验收）,33-已完成（已入库")
