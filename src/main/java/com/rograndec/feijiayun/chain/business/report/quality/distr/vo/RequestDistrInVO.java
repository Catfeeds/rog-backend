 ...
 * dongdong.zhang
 */
public class RequestDistrInVO implements Serializable {
    /**
     */
    ...
    private Integer inDateOrder=0;
    @ApiModelProperty(value = "按单号排序  0倒序  1正序  默认0")
    private Integer inCodeOrder=0;
     ...
     * 
     */
    @ApiModelProperty("入库日期(从)")
    private Date startInDate;
    
    /**
     * 
     */
    @ApiModelProperty("入库日期(至)")
    ...
    /**
     * 状态  32-待入库  41-待开票【已完成（已入库）】
     */
    @ApiModelProperty(value = "状态 32-待入库  41-已入库")
  ...
  /*  @ApiModelProperty(value = "流通监管码")
	...
	public Integer getInDateOrder() {
		return inDateOrder;
	}

	public void setInDateOrder(Integer inDateOrder) {
		this.inDateOrder = inDateOrder;
	}

	public Integer getInCodeOrder() {
		return inCodeOrder;
	}

	public void setInCodeOrder(Integer inCodeOrder) {
		this.inCodeOrder = inCodeOrder;
	}
