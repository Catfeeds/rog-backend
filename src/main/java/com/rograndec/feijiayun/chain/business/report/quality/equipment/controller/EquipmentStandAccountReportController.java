 ...
 * @author lizhongyi
 */
@Api(value = "report_quality_equipment_equipmentStandAccount", description = "报表-质量管理-设施与设备-设施设备台账")
@RestController
@RequestMapping("/report/quality/equipment/equipmentStandAccount")
@Validated
public class EquipmentStandAccountReportController {
	private static final Logger logger = LoggerFactory.getLogger(EquipmentStandAccountReportController.class);

	@Autowired
	private EquipmentService equipmentService;

	@ApiOperation(value = "设施设备台账报表", notes = "获取数据 | 开发者 zhengbin.jin | 开发完成", produces = MediaType.APPLICATION_JSON_VALUE)
	@ResponseBody
	@RequestMapping(value = "/getEquipmentReportByParam", method = RequestMethod.POST)
	public Result<Page<List<Equipment>>> getEquipmentReportByParam(HttpSession session,
	...
	@ApiOperation(value = "设施设备台账报表-获取打印数据", notes = "获取数据 | 开发者 zhengbin.jin | 开发完成", produces = MediaType.APPLICATION_JSON_VALUE)
	@ResponseBody
	@RequestMapping(value = "/getEquipmentPrintByParam", method = RequestMethod.POST)
	public Result<List<Equipment>> getEquipmentPrintByParam(HttpSession session,
		...
		try {
			UserVO userVO = (UserVO) session.getAttribute("user");
			List<Equipment> equipmentList = equipmentService.listEquipmentPrintData(userVO, requestEquipmentListEVO);
	...
	@ApiOperation(value = "设施设备台账报表-导出数据", notes = "获取数据 | 开发者 zhengbin.jin | 开发完成")
