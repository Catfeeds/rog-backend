 ...
 *
 */
@Api(value = "report_quality_purchase_goodsLicenseWarn",description = "报表-质量管理-采购-品种资质预警")
@RestController
@RequestMapping("report/quality/purchase/goodsLicenseWarn")
@Validated
public class GoodsLicenseWarnReportController {

    private static final Log logger = LogFactory.getLog(GoodsLicenseWarnReportController.class);

    @Autowired
    GoodsLicenseWarnReportService goodsLicenseWarnReportService;
    ...
    @ResponseBody
    public Result<Page<List<GoodsLicenseWarnVO>>> getGoodsLicenseWarn(HttpServletRequest request,
        ...
        Result<Page<List<GoodsLicenseWarnVO>>> result = new Result<>();
        try {
            HttpSession session = request.getSession(true);
            UserVO loginUser = (UserVO) session.getAttribute("user");
            result.setBizCodeSuccessInfo(SysCode.SUCCESS, goodsLicenseWarnReportService.getGoodsLicenseWarn(loginUser,businessVariety, param,orderName,orderType,pageNo,pageSize));
        } catch (Exception e) {
    ...
    public void exportExcel(HttpServletRequest request, HttpServletResponse response,
        ...
        try {
            ...
            goodsLicenseWarnReportService.exportExcel(output, loginUser, param, orderName, orderType, businessVariety);
        } catch (Exception e) {
