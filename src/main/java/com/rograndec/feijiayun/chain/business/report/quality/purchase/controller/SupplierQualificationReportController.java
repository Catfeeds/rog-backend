 ...
 *
 */
@Api(value = "report_quality_purchase_supplierQualification",description = "报表-质量管理-采购-供货单位资质")
@RestController
@RequestMapping("report/quality/purchase/supplierQualification")
@Validated
public class SupplierQualificationReportController {

    @Autowired
    private SupplierQualificationReportService supplierQualificationReportService;


    @ApiOperation(value = "报表-质量管理-采购-供货单位资质分页查询", notes = "报表-质量管理-采购-供货单位资质分页查询 | 开发者 孙腾 | 已联调")
    ...
    public Result<Page<List<SupplierQualificationReportVO>>> getEnterpriseOrgQualificationReport(HttpSession session, @RequestBody RequestParamSupplierReportVO paramForListVO){
        ...
        supplierQualificationReportService.getSupplierQualificationList(page,paramForListVO,userVO);
    ...
    @ApiOperation(value = "导出Excel", notes = "导出供货单位资质Excel | 开发者 孙腾 | 已联调")
    ...
    public void exportExcel(HttpServletResponse response, HttpSession session, @ApiParam(value = "供货单位编码、名称、检索码", required = false) @RequestParam(required = false) String param,
        ...
        supplierQualificationReportService.export(output,userVO,paramForListVO);
