 ...
 *
 */
@Api(value = "report_quality_purchase_supplierSaler",description = "报表-质量管理-采购-供货单位销售人员")
@RestController
@RequestMapping("report/quality/purchase/supplierSaler")
@Validated
public class SupplierSalerReportController {

    @Autowired
    private SupplierQualificationReportService supplierQualificationReportService;

    @ApiOperation(value = "报表-质量管理-采购-供货单位销售人员分页查询", notes = "报表-质量管理-采购-供货单位销售人员分页查询 | 开发者 孙腾 | 已联调")
    @RequestMapping(value="/getSupplierSalerReport",method= RequestMethod.POST)
    @ApiImplicitParam(name = "paramForListVO", value = "检索条件", required = true, dataType = "RequestParamSupplierReportVO")
    public Result<Page<List<SupplierQualificationReportVO>>> getSupplierSalerReport(HttpSession session, @RequestBody RequestParamSupplierReportVO paramForListVO){
        ...
        supplierQualificationReportService.getSupplierSalesList(page,paramForListVO,userVO);
    ...
    @ApiOperation(value = "导出供货单位销售人员预警Excel", notes = "导出供货单位销售人员预警Excel | 开发者 孙腾 | 已联调")
    ...
    public void exportExcel(HttpServletResponse response, HttpSession session, @ApiParam(value = "供货单位编码、名称、检索码", required = false) @RequestParam(required = false) String param,
        ...
        supplierQualificationReportService.exportSupplierSaler(output,userVO,paramForListVO);
