 ...
 */
@Service
public class GoodsStopSaleReportServiceImpl implements GoodsStopSaleReportService {
    ...
    @Override
    public Page getGoodsStopSaleReportList(RequestReportGoodsStopSaleVO requestVO, Page page, UserVO userVO) throws Exception {
        ...
        BaseGoodsReportTotalVO<GoodsStopSaleReportVO> stopSaleTotalVO = new BaseGoodsReportTotalVO<>();
        //获取总数量
        BigDecimal quantityTotal = goodsSeriesReportMapper.getGoodsStopSaleReportQuantityTotal(requestVO);
        stopSaleTotalVO.setQuantityTotal(quantityTotal == null?BigDecimal.ZERO:quantityTotal);
        ...
        List<GoodsStopSaleReportVO> goodsStopSaleReportVOList = goodsSeriesReportMapper.getGoodsStopSaleReport(requestVO);
        stopSaleTotalVO.setGoodsReportList(goodsStopSaleReportVOList == null ? new ArrayList<>() : goodsStopSaleReportVOList);

        page.setResult(stopSaleTotalVO);
        if (hPage != null) {
    ...
    @Override
    public void excelExport(OutputStream output, BaseGoodsReportTotalVO<GoodsStopSaleReportVO> totalVO, UserVO userVO) {
        //标题数据
        ...
        map.put("stopDate", "日期");
        map.put("stopCode", "单号");
        map.put("stopManName", "通知人员");
        map.put("stopFromDesc", "通知来源");
