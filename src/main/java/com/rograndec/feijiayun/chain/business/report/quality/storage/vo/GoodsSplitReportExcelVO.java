...
public class GoodsSplitReportExcelVO implements Serializable{
    ...
    private String splitGoodsSpecification;
    ...
    public String getSplitGoodsSpecification() {
        return splitGoodsSpecification;
    }

    public void setSplitGoodsSpecification(String splitGoodsSpecification) {
        this.splitGoodsSpecification = splitGoodsSpecification;
    }
    ...
    public String toString() {
        return "GoodsSplitReportExcelVO{" +
                "id=" + id +
                ...
                ", splitGoodsSpecification='" + splitGoodsSpecification + '\'' +
    ...
    public static GoodsSplitReportExcelVO convertTOExcel(GoodsSplitReportPageVO vo) {
        GoodsSplitReportExcelVO excelVO = new GoodsSplitReportExcelVO();
        excelVO.setId(vo.getId());
        excelVO.setEnterpriseCode(vo.getEnterpriseCode());
        excelVO.setEnterpriseName(vo.getEnterpriseName());
        excelVO.setSplitDate(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(vo.getSplitDate()));
        excelVO.setCode(vo.getCode());
        excelVO.setSplitManName(vo.getSplitManName());
        ...
        excelVO.setSplitGoodsCode(vo.getSplitGoodsCode());
        excelVO.setSplitGoodsSpecification(vo.getSplitGoodsSpecification());
        excelVO.setSplitUnitName(vo.getSplitUnitName());
        excelVO.setSplitShelfName(vo.getSplitShelfName());
        excelVO.setSplitShelfStatusDesc(vo.getSplitShelfStatusDesc());
        excelVO.setSplitQuantity(vo.getSplitQuantity());
