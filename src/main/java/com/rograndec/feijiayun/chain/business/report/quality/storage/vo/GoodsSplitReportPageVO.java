...
public class GoodsSplitReportPageVO implements Serializable{
    /**
     * 主键ID
     */
    ...
    public static GoodsSplitReportPageVO convertTOStr(GoodsSplitReportPageVO goodsVO) {
        //0-成药；1-中药材；2-中药饮片
        ...
        if (goodsVO.getSpecialDrug() != null){
            specilDrug.append(SpecialDrugsAll.getName(goodsVO.getSpecialDrug()));
        ...
        if(goodsVO.getInChargeDrug() != null){
            inChargeDrug.append(InChargeDrug.getName(goodsVO.getInChargeDrug()));
