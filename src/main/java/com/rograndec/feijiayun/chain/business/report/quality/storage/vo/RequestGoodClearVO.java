...
public class RequestGoodClearVO implements Serializable{
    ...
    @ApiModelProperty(value = "清斗起始日期")
    private Date startTime;

    @ApiModelProperty(value = "清斗终止日期")
    ...
    @ApiModelProperty(value = "状态 0-禁止 1-启用")
    ...
    @ApiModelProperty(value = "按某一列排序(clearDate或者code)")
