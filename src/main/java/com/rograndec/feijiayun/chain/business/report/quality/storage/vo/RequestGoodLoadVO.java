...
public class RequestGoodLoadVO implements Serializable{
    ...
    @ApiModelProperty(value = "装斗起始日期")
    private Date startTime;

    @ApiModelProperty(value = "装斗终止日期")
    ...
    @ApiModelProperty(value = "按某一列排序(loadDate或者code)")
