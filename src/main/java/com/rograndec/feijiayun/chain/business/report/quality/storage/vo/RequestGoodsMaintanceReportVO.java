 ...
 * 2017-09-28
 */
public class RequestGoodsMaintanceReportVO implements Serializable {
	   @ApiModelProperty(value = "页码") private int pageNo;
       @ApiModelProperty(value = "每页显示的记录数") private int pageSize;
       @ApiModelProperty(value = "商品编码/条形码/商品名称/通用名称/批准文号") private String param;
		@ApiModelProperty(value = "养护日期（从）") private Date startDate;
		@ApiModelProperty(value = "养护日期（至）") private Date endDate;
		...
		@ApiModelProperty(value = "养护单号") private String code;
		@ApiModelProperty(value = "养护人员") private String maintanceManName;
		@ApiModelProperty(value = "养护类型（0-重点养护；1-常规养护）") private String maintanceType;
		@ApiModelProperty(value = "药品类型（0-成药；1-中药饮片；2-拆零药品；3-近效期药品）") private String goodsType;
		@ApiModelProperty(value = "状态（31-计划中|32-养护中|33-已完成|34-已取消）") private String status;
		@ApiModelProperty(value = "商品分类") private String categoryId;
		@ApiModelProperty(value = "国产/进口（0-国产；1-进口）") private String domesticImport;
		@ApiModelProperty(value = "储藏温度（0-常温；1-阴凉；2-冷藏；3-冷冻）") private String storageTemp;
		@ApiModelProperty(value = "储藏条件") private String storageConditionName;
		@ApiModelProperty(value = "注册商标") private String registeredTrademark;
		@ApiModelProperty(value = "商品属性（0-成药；1-中药材；2-中药饮片）") private String goodsAttribute;
		@ApiModelProperty(value = "品牌") 
		private String brand;
		@ApiModelProperty(value = "商品为成药时是否为处方药（0：非处方药，1：处方药）") private String prescriptionDrug;
		@ApiModelProperty(value = "为非处方药时甲类还是乙类（0-甲类；1-乙类）") private String otcType;
		    @ApiModelProperty(value = "经营范围") private String managementScopeId;
		@ApiModelProperty(value = "特殊管理药品（0-精神药品；1-麻醉药品；2-医疗用毒性药品；3-放射性药品）") private String specialDrug;
		@ApiModelProperty(value = "精神药品分类（0-一类；1-二类）") private String spiritDrugType;
		@ApiModelProperty(value = "专管药品（0-含特殊药品复方制剂；1-蛋白同化制剂；2-肽类激素）") private String inChargeDrug;         					
		@ApiModelProperty(value = "含特殊药品复方制剂类型（0-含可卡因复方口服液；1-含麻黄碱类复方制剂；2-复方地芬诺酯片；3-复方甘草片）") private String formulationType;
