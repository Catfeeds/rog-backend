 ...
 * dongdong.zhang
 */
public class RequestNearEffectExportVO implements Serializable {
    /**
     */
	...
	public RequestNearEffectExportVO(String param, Integer chainType, String enterpriseCode, String enterpriseName,
			Long categoryId, Integer domesticImport, Integer storageTemp, String storageConditionName,
			String registeredTrademark, String brand, Integer goodsAttribute, Integer prescriptionDrug, Integer otcType,
			Long managementScopeId, Integer specialDrug, Integer inChargeDrug) {
		super();
		this.param = param;
		this.chainType = chainType;
		this.enterpriseCode = enterpriseCode;
	...
	public RequestNearEffectExportVO() {
		super();
	}
