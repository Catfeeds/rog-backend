...
public class RequestOtherInVO implements Serializable{
    ...
    @ApiModelProperty(value = "入库起始日期")
    private Date startTime;

    @ApiModelProperty(value = "入库终止日期")
    ...
    @ApiModelProperty(value = "入库类型0-获赠；1-报溢；2-领用退回；3-其它")
    ...
    @ApiModelProperty(value = "按某一列排序(inDate或者code)")
