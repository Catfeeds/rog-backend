...
public class RequestOtherOutVO implements Serializable{
    /**
    ...
    @ApiModelProperty(value = "出库起始日期")
    private Date startTime;

    @ApiModelProperty(value = "出库终止日期")
    ...
    @ApiModelProperty(value = "出库类型0-赠送；1-报损；2-内部领用；3-抽检出库；4-其它")
    private Integer outType;

    /**
     * 流向单位类型（0-部门；1-总部；2-门店；3-供货单位）
     */
    @ApiModelProperty(value = "流向单位类型（0-部门；1-总部；2-门店；3-供货单位）")
    ...
    private Long storageConditionName;
    ...
    @ApiModelProperty(value = "按某一列排序(outDate或者code)")
    ...
    public Long getStorageConditionName() {
        return storageConditionName;
    }

    public void setStorageConditionName(Long storageConditionName) {
