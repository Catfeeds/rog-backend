...
public class RequestShelfMoveVO implements Serializable{
    ...
    @ApiModelProperty(value = "移动起始日期")
    private Date startTime;

    @ApiModelProperty(value = "移动终止日期")
    private Date endTime;

    @ApiModelProperty(value = "移动单号")
    private String code;

    @ApiModelProperty(value = "移动人员")
    ...
    @ApiModelProperty(value = "按某一列排序(moveDate或者code)")
