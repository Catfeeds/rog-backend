...
@ApiModel(value = "SaleAnalyClerkBranchDoubleClickDetailResultTotalVO", description = "按日结标识、日期查询销售流水列表（分店）查询结果对象")
public class SaleAnalyClerkBranchDoubleClickDetailResultTotalVO implements Serializable{
	...
	private List<SaleAnalyClerkBranchDoubleClickDetailResultVO> resultBranchVOList;
	...
	public List<SaleAnalyClerkBranchDoubleClickDetailResultVO> getResultBranchVOList() {
		return resultBranchVOList;
	}

	public void setResultBranchVOList(
			List<SaleAnalyClerkBranchDoubleClickDetailResultVO> resultBranchVOList) {
