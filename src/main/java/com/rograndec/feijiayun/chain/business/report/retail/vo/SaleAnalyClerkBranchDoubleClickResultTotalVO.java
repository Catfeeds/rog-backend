...
public class SaleAnalyClerkBranchDoubleClickResultTotalVO implements Serializable{
	/**
    ...
    private List<SaleAnalyClerkBranchDoubleClickResultVO> branchVOList;
	...
	public List<SaleAnalyClerkBranchDoubleClickResultVO> getBranchVOList() {
		return branchVOList;
	}

	public void setBranchVOList(List<SaleAnalyClerkBranchDoubleClickResultVO> branchVOList) {
