...
public class SaleAnalyPayeeResultBranchTotalVO implements Serializable{
	/**
    ...
    private List<SaleAnalyPayeeResultBranchVO> branchVOList;
	...
	public List<SaleAnalyPayeeResultBranchVO> getBranchVOList() {
		return branchVOList;
	}

	public void setBranchVOList(List<SaleAnalyPayeeResultBranchVO> branchVOList) {
