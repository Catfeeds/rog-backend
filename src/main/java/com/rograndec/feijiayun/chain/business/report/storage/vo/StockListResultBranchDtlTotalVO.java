...
public class StockListResultBranchDtlTotalVO implements Serializable{
	...
	private List<StockListResultBranchDtlVO> voList;
	...
	public List<StockListResultBranchDtlVO> getVoList() {
		return voList;
	}

	public void setVoList(List<StockListResultBranchDtlVO> voList) {
		this.voList = voList;
	}
