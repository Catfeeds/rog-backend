...
public class StockWarnGoodsMaintanceTotalVO implements Serializable{
	...
	private List<StockWarnGoodsMaintanceVO> voList;
	...
	public List<StockWarnGoodsMaintanceVO> getVoList() {
		return voList;
	}

	public void setVoList(List<StockWarnGoodsMaintanceVO> voList) {
		this.voList = voList;
	}
