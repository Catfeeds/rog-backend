...
public class StockWarnLagSaleGoodsTotalVO implements Serializable{
	...
	private List<StockWarnLagSaleGoodsVO> voList;
	...
	public List<StockWarnLagSaleGoodsVO> getVoList() {
		return voList;
	}

	public void setVoList(List<StockWarnLagSaleGoodsVO> voList) {
		this.voList = voList;
	}
