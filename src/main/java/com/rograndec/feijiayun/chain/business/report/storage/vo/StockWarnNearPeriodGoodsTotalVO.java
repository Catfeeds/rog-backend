...
public class StockWarnNearPeriodGoodsTotalVO implements Serializable{
	...
	private List<StockWarnNearPeriodGoodsVO> voList;
	...
	public List<StockWarnNearPeriodGoodsVO> getVoList() {
		return voList;
	}

	public void setVoList(List<StockWarnNearPeriodGoodsVO> voList) {
		this.voList = voList;
	}
