 ...
 */
public class WillDailySettleDetailExportVO implements Serializable {
    ...
    public String toString() {
        return "WillDailySettleDetailExportVO{" +
                "id=" + id +
                ", date=" + date +
    ...
    public boolean equals(Object o) {
        ...
        WillDailySettleDetailExportVO that = (WillDailySettleDetailExportVO) o;
