 ...
 */
@ApiModel(value = "PosPayeeAuthSaveOrupdateVO", description = "零售管理-POS管理-款员权限")
public class PosPayeeAuthSaveOrupdateVO implements Serializable {
	...
	public void setStatus(Integer status) {
		this.status = status == null ? 1 : status; // 默认值为1启用
	}
