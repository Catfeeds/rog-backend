...
/**
 * 
 * saas_prescription_register_shelf
 * 
 * 
 * @author ST
 * 
 * 2017-09-22
 */
public class PrescriptionRegisterShelf implements Serializable {
    /**
     * 主键ID
     */
     ...
     * 处方登记明细ID
     */
    @ApiModelProperty(value = "处方登记明细ID")
    private Long registerDtlId;

    /**
     * 单据（处方登记单）ID
     */
    @ApiModelProperty(value = "单据（处方登记单）ID")
    ...
    /**
     * 处方登记明细ID
     * @return register_dtl_id 处方登记明细ID
     */
    ...
    /**
     * 单据（处方登记单）ID
     * @return register_id 单据（处方登记单）ID
     */
