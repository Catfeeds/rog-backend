 ...
 * 2017-09-25
 */
public class SaleShelf implements Serializable {
    /**
     * 主键ID
     */
     ...
     * 品种明细单ID
     */
    @ApiModelProperty(value = "品种明细单ID")
    ...
    public String toString() {
        ...
        sb.append(", saleDtlId=").append(saleDtlId);
