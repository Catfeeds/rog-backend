 ...
 * 2017-09-22
 */
public class SpecialRegisterDetail implements Serializable {
    /**
     * 主键ID
     */
     ...
     * 单据（专管登记单单）ID
     */
    @ApiModelProperty(value = "单据（专管登记单单）ID")
    private Long registerId;

    /**
     * 单据（专管登记单）类型
     */
    @ApiModelProperty(value = "单据（专管登记单）类型")
    private Integer orderType;

    /**
     * 单据（专管登记单）编码
     */
    @ApiModelProperty(value = "单据（专管登记单）编码")
    private String registerCode;

    /**
     * 单据（专管登记单）日期
     */
    @ApiModelProperty(value = "单据（专管登记单）日期")
     ...
     * 商品货位信息明细
     */
    private List<SpecialRegisterShelf> specialRegisterShelfList;

    public List<SpecialRegisterShelf> getSpecialRegisterShelfList() {
        return specialRegisterShelfList;
    }

    public void setSpecialRegisterShelfList(List<SpecialRegisterShelf> specialRegisterShelfList) {
        this.specialRegisterShelfList = specialRegisterShelfList;
    }
    ...
    /**
     * 单据（专管登记单单）ID
     * @return register_id 单据（专管登记单单）ID
     */
    ...
    /**
     * 单据（专管登记单）编码
     * @return register_code 单据（专管登记单）编码
     */
    ...
    /**
     * 单据（专管登记单）编码
     * @param registerCode 单据（专管登记单）编码
     */
    ...
    /**
     * 单据（专管登记单）日期
     * @return register_date 单据（专管登记单）日期
     */
    ...
    /**
     * 单据（专管登记单）日期
     * @param registerDate 单据（专管登记单）日期
     */
