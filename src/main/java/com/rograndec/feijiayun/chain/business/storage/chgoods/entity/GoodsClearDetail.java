...
public class GoodsClearDetail implements Serializable {
    /**
     * 主键ID
     */
     ...
     * 单据（中药清斗）ID
     */
    @ApiModelProperty(value = "单据（中药清斗）ID")
    private Long clearId;

    /**
     * 单据（中药清斗）类型
     */
    @ApiModelProperty(value = "单据（中药清斗）类型")
    private Integer orderType;

    /**
     * 单据（中药清斗）编码
     */
    @ApiModelProperty(value = "单据（中药清斗）编码")
    private String clearCode;

    /**
     * 单据（中药清斗）日期
     */
    @ApiModelProperty(value = "单据（中药清斗）日期")
    ...
    /**
     * 单据（中药清斗）编码
     * @param clearCode 单据（中药清斗）编码
     */
    public void setClearCode(String clearCode) {
        this.clearCode = clearCode == null ? null : clearCode.trim();
    }

    /**
     * 单据（中药清斗）日期
     * @return clear_date 单据（中药清斗）日期
     */
    ...
    public String toString() {
        ...
        sb.append(", clearId=").append(clearId);
        sb.append(", orderType=").append(orderType);
        sb.append(", clearCode=").append(clearCode);
