 ...
 * 2017-09-26
 */
public class GoodsDisplayCheckDetailVO implements Serializable {
    /**
     * 主键ID
     */
     ...
     * 单据（陈列检查单）ID
     */
    @ApiModelProperty(value = "单据（陈列检查单）ID")
    private Long checkId;

    /**
     * 单据（陈列检查单）类型
     */
    @ApiModelProperty(value = "单据（陈列检查单）类型")
    private Integer orderType;

    /**
     * 单据（陈列检查单）编码
     */
    @ApiModelProperty(value = "单据（陈列检查单）编码")
    private String checkCode;

    /**
     * 单据（陈列检查单）日期
     */
    @ApiModelProperty(value = "单据（陈列检查单）日期")
    ...
    public String toString() {
        return "GoodsDisplayCheckDetailVO{" +
                "id=" + id +
                ", checkId=" + checkId +
                ", orderType=" + orderType +
                ", checkCode='" + checkCode + '\'' +
