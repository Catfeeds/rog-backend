 ...
 * 2017-09-26
 */
public class GoodsDisplayCheckVO implements Serializable {
    /**
     * 主键ID
     */
     ...
     * 养护类型名（0-重点养护；1-常规养护）
     */
    @ApiModelProperty(value = "养护类型名（0-重点养护；1-常规养护）")
    ...
    /**
     * 药品类型名（0-成药；1-中药饮片；2-拆零药品；3-近效期药品）
     */
    @ApiModelProperty(value = "药品类型名")
