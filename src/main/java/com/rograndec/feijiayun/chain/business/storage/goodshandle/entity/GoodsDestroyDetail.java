 ...
 * 2017-10-18
 */
public class GoodsDestroyDetail implements Serializable {
    /**
     * 主键ID
     */
    ...
    /**
     * 单据（药品销毁单）编码
     * @return destroy_code 单据（药品销毁单）编码
     */
    ...
    /**
     * 单据（药品销毁单）编码
     * @param destroyCode 单据（药品销毁单）编码
     */
    public void setDestroyCode(String destroyCode) {
        this.destroyCode = destroyCode == null ? null : destroyCode.trim();
    }

    /**
     * 单据（药品销毁单）日期
     * @return destroy_date 单据（药品销毁单）日期
     */
    ...
    public String toString() {
        ...
        sb.append(", destroyId=").append(destroyId);
        sb.append(", orderType=").append(orderType);
        sb.append(", destroyCode=").append(destroyCode);
        sb.append(", destroyDate=").append(destroyDate);
