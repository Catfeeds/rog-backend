 ...
 * 2017-09-27
 */
public class GoodsHandleDetail implements Serializable {
    /**
     * 主键ID
     */
     ...
     * 单据（药品处理单）ID
     */
    @ApiModelProperty(value = "单据（药品处理单）ID")
    private Long handleId;

    /**
     * 单据（药品处理单）类型
     */
    @ApiModelProperty(value = "单据（药品处理单）类型")
    private Integer orderType;

    /**
     * 单据（药品处理单）编码
     */
    @ApiModelProperty(value = "单据（药品处理单）编码")
    private String handleCode;

    /**
     * 单据（药品处理单）日期
     */
    @ApiModelProperty(value = "单据（药品处理单）日期")
    ...
    @ApiModelProperty(value = "商品处理单货位信息")
    private List<GoodsHandleShelf> goodsHandleShelfList;
    /**
     * saas_goods_handle_detail
     */
    private static final long serialVersionUID = 1L;

    public List<GoodsHandleShelf> getGoodsHandleShelfList() {
        return goodsHandleShelfList;
    }

    public void setGoodsHandleShelfList(List<GoodsHandleShelf> goodsHandleShelfList) {
        this.goodsHandleShelfList = goodsHandleShelfList;
    }
    ...
    /**
     * 单据（药品处理单）编码
     * @return handle_code 单据（药品处理单）编码
     */
    ...
    /**
     * 单据（药品处理单）日期
     * @return handle_date 单据（药品处理单）日期
     */
