 ...
 * 2017-09-27
 */
public class GoodsHandleShelf implements Serializable {
    /**
     * 主键ID
     */
     ...
     * 商品锁定单ID
     */
    @ApiModelProperty(value = "商品锁定单ID")
    private Long lockId;
