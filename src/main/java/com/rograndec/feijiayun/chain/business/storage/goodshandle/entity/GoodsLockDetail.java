...
/**
 * saas_goods_lock_detail
 *
 * @author Administrator
 * <p>
 * 2017-09-27
 */
public class GoodsLockDetail implements Serializable {
    /**
     * 主键ID
     */
     ...
     * 单据（药品锁定单）ID
     */
    @ApiModelProperty(value = "单据（药品锁定单）ID")
    private Long lockId;

    /**
     * 单据（药品锁定单）类型
     */
    @ApiModelProperty(value = "单据（药品锁定单）类型")
    ...
    @ApiModelProperty(value = "商品货位信息")
    private List<GoodsLockShelf> goodsLockShelfList;


    public List<GoodsLockShelf> getGoodsLockShelfList() {
        return goodsLockShelfList;
    }

    public void setGoodsLockShelfList(List<GoodsLockShelf> goodsLockShelfList) {
        this.goodsLockShelfList = goodsLockShelfList;
    }
