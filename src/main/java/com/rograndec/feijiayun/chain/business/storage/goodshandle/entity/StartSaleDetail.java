 ...
 * 2017-09-27
 */
public class StartSaleDetail implements Serializable {
    /**
     * 主键ID
     */
     ...
     * 单据（解停通知单）ID
     */
    @ApiModelProperty(value = "单据（解停通知单）ID")
    private Long startId;

    /**
     * 单据（解停通知单）类型
     */
    @ApiModelProperty(value = "单据（解停通知单）类型")
    private Integer orderType;

    /**
     * 单据（解停通知单）编码
     */
    @ApiModelProperty(value = "单据（解停通知单）编码")
    private String startCode;

    /**
     * 单据（解停通知单）日期
     */
    @ApiModelProperty(value = "单据（解停通知单）日期")
    ...
    private List<StartSaleShelf> startSaleShelves;

    public List<StartSaleShelf> getStartSaleShelves() {
        return startSaleShelves;
    }

    public void setStartSaleShelves(List<StartSaleShelf> startSaleShelves) {
        this.startSaleShelves = startSaleShelves;
    }
    ...
    /**
     * 解停原因
     * @param startReason 解停原因
     */
    public void setStartReason(String startReason) {
        this.startReason = startReason == null ? null : startReason.trim();
    }
    ...
    public String toString() {
        ...
        sb.append(", startReason=").append(startReason);
