 ...
 * 2017-09-27
 */
public class StopSaleDetail implements Serializable {
    /**
     * 主键ID
     */
     ...
     * 单据（停售通知单）ID
     */
    @ApiModelProperty(value = "单据（停售通知单）ID")
    private Long stopId;

    /**
     * 单据（停售通知单）类型
     */
    @ApiModelProperty(value = "单据（停售通知单）类型")
    private Integer orderType;

    /**
     * 单据（停售通知单）编码
     */
    @ApiModelProperty(value = "单据（停售通知单）编码")
    private String stopCode;

    /**
     * 单据（停售通知单）日期
     */
    @ApiModelProperty(value = "单据（停售通知单）日期")
    ...
    private List<StopSaleShelf> stopSaleShelves;

    public List<StopSaleShelf> getStopSaleShelves() {
        return stopSaleShelves;
    }

    public void setStopSaleShelves(List<StopSaleShelf> stopSaleShelves) {
        this.stopSaleShelves = stopSaleShelves;
    }
