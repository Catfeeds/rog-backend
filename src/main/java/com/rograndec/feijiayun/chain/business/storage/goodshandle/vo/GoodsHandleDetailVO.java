...
import javax.validation.constraints.NotNull;
 ...
 /**
 * 
 * @ClassName: GoodsHandleDetailVO
 * @Description:  储存管理-商品处理-药品处理明细
 * @author zhengbin.jin
 * @version 1.0 
 * @date 2017-09-27 17:27:49
 */
@ApiModel(value = "GoodsHandleDetailVO", description = "储存管理-商品处理-药品处理明细")
public class GoodsHandleDetailVO implements Serializable {
     ...
     * 单据（药品处理单）类型
     */
	@ApiModelProperty(required = true, value = "单据（药品处理单）类型")
	private Integer orderType;
	
	/**
     * 单据（药品处理单）编码
     */
	@ApiModelProperty(required = true, value = "单据（药品处理单）编码")
	private String handleCode;
	
	/**
     * 单据（药品处理单）日期
     */
	@ApiModelProperty(required = true, value = "单据（药品处理单）日期")
