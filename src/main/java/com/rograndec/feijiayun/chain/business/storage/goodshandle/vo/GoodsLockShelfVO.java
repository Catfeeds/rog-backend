...
import javax.validation.constraints.NotNull;
 ...
 /**
 * 
 * @ClassName: GoodsLockShelfVO
 * @Description:  储存管理-商品处理-药品锁定货位明细
 * @author zhengbin.jin
 * @version 1.0 
 * @date 2017-09-27 17:27:10
 */
@ApiModel(value = "GoodsLockShelfVO", description = "储存管理-商品处理-药品锁定货位明细")
public class GoodsLockShelfVO implements Serializable {
     ...
     * 明细单ID
     */
	@ApiModelProperty(required = true, value = "明细单ID")
	private Long dtlId;
