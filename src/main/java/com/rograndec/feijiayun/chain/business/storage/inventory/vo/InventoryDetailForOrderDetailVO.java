 ...
 * 2017-09-29
 */
public class InventoryDetailForOrderDetailVO implements Serializable {
    /**
     * 主键ID
     */
    ...
    @ApiModelProperty(value = "商品名称的拼音码")
    private String goodsNamePinyin;

    @ApiModelProperty(value = "商品通用名称的拼音码")
    private String goodsGenericNamePinyin;
    ...
    @ApiModelProperty(value = "实盘数量excel导出使用")
    private Integer invQuantityExcel;
    ...
    public String getGoodsGenericNamePinyin() {
        return goodsGenericNamePinyin;
    }

    public void setGoodsGenericNamePinyin(String goodsGenericNamePinyin) {
        this.goodsGenericNamePinyin = goodsGenericNamePinyin;
    }

    public Integer getInvQuantityExcel() {
        return invQuantityExcel;
    }

    public void setInvQuantityExcel(Integer invQuantityExcel) {
        this.invQuantityExcel = invQuantityExcel;
    }
}