...
/**
 * 功能描述：
 * Created by ST on 2017/10/28 16:30
 */

public class InventoryGoodsInfoVO {

    @ApiModelProperty(value = "盘点单货位明细id,按货位盘点的查询商品返回此ID,盘点登记是提交此ID")
    private Long inventoryShelfId;

    @ApiModelProperty(value = "盘点单明细id,按商品盘点的查询的商品信息返回此ID,盘点登记时提交此ID")
    private Long id;
