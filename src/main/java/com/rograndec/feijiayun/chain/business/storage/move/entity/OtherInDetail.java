...
public class OtherInDetail implements Serializable {
     ...
     * 单据（其它入库单）ID
     */
    @ApiModelProperty(value = "单据（其它入库单）ID")
    private Long inId;

    /**
     * 单据（其它入库单）类型
     */
    @ApiModelProperty(value = "单据（其它入库单）类型")
    private Integer orderType;

    /**
     * 单据（其它入库单）编码
     */
    @ApiModelProperty(value = "单据（其它入库单）编码")
    private String inCode;

    /**
     * 单据（其它入库单）日期
     */
    @ApiModelProperty(value = "单据（其它入库单）日期")
    private Date inDate;
     ...
     * 进项税ID
     */
    @ApiModelProperty(value = "进项税ID/销项税ID")
    private Long taxRateId;

    /**
     * 进项税
     */
    @ApiModelProperty(value = "进项税/销项税")
