 ...
 * 2017-09-27
 */
public class ShelfMoveDetail implements Serializable {
    /**
     * 主键ID
     */
     ...
     * 单据（货位移动）ID
     */
    @ApiModelProperty(value = "单据（货位移动）ID")
    private Long moveId;

    /**
     * 单据（货位移动）类型
     */
    @ApiModelProperty(value = "单据（货位移动）类型")
    private Integer orderType;

    /**
     * 单据（货位移动）编码
     */
    @ApiModelProperty(value = "单据（货位移动）编码")
    ...
    public String toString() {
        ...
        sb.append(", moveCode=").append(moveCode);
