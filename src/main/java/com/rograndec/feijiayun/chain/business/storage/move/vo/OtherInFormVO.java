...
public class OtherInFormVO implements Serializable{
    /**
     * 主键ID
     */
     ...
     * 超量销售单号集合
     */
    @ApiModelProperty(value = "超量销售单号集合---超量销售时传给我---用，隔开")
    ...
    public static OtherInFormVO convertToVO(OtherIn otherIn) {
        OtherInFormVO vo = new OtherInFormVO();
        ...
        vo.setExcessiveSaleCodes(otherIn.getExcessiveSaleCodes());
        return vo;
    }
}
