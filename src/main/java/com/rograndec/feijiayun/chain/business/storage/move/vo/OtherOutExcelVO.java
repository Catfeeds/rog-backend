...
public class OtherOutExcelVO implements Serializable {
    ...
    public static OtherOutExcelVO convertToVO(OtherOutDetailPageVO s, OtherOutShelfPageVO shelfPageVO) {
        OtherOutExcelVO vo = new OtherOutExcelVO();
        ...
        vo.setLotNumber(shelfPageVO.getLotNumber());
        vo.setProductDate(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(shelfPageVO.getProductDate()));
        vo.setValidDate(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(shelfPageVO.getValidDate()));
        vo.setShelfName(shelfPageVO.getShelfName());
        ...
        vo.setShelfStatusDesc(shelfPageVO.getShelfStatusDesc());
