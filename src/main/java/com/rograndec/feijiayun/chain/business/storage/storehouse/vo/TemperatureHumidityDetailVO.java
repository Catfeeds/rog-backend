 ...
 * 2017-09-27
 */
public class TemperatureHumidityDetailVO implements Serializable {
    ...
    public void setAmTime(String amTime) {
    	if(amTime!=null&&!amTime.trim().equals("")){
    		this.amTime = amTime;
    	}
    }
    ...
    public void setAmMeasure(String amMeasure) {
    	if(amMeasure!=null&&!amMeasure.trim().equals("")){
    ...
    public void setPmTime(String pmTime) {
    	if(pmTime!=null&&!pmTime.trim().equals("")){
        this.pmTime = pmTime;
    	}
    }
