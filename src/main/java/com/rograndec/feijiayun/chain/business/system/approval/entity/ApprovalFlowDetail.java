...
public class ApprovalFlowDetail implements Serializable {
    ...
    public static ApprovalFlowDetail getDefPriceAdjustApprovalFlowDetail(UserVO userVO,Enterprise enterprise,Long flowId,SysRole SalesManagerRole) throws Exception {
         ...
         * 企业ID
         */
        approvalFlowDetail.setEnterpriseId(enterprise.getId());

        /**
         * 上级企业ID
         */
        approvalFlowDetail.setParentId(enterprise.getParentId());

        /**
         * 审批阶段
         */
        approvalFlowDetail.setApprovalStage("审批阶段一");
         ...
         * 角色ID
         */
        approvalFlowDetail.setRoleId(SalesManagerRole.getId());

        /**
         * 角色名称
         */
        approvalFlowDetail.setRoleName(SalesManagerRole.getName());
         ...
         * 最高级别
         */
        approvalFlowDetail.setHighestLevel(1);
        ...
        UserEnterpriseUtils.setUserCreateOrModify(approvalFlowDetail,userVO,true);
    ...
    public static List<ApprovalFlowDetail> getApprovalFlow4approvalFlowDetailVO(
        ...
        List<ApprovalFlowDetail> resultApprovalFlowDetails = new ArrayList<>();
    ...
    public static List<ApprovalFlowDetail> getApprovalFlow4approvalFlowDetail(
            List<SaveOrUpdateApprovalFlowDetailVO> approvalFlowDetailDTOS
            , Enterprise userEnterprise
            , List<Enterprise> detailStartEnterprise
            , UserVO user
    ...
    private static void setApprovalFlowDetails(SaveOrUpdateApprovalFlowDetailVO approvalFlowDetailPojo
            ...
            , UserVO user
            , List<SaveOrUpdateApprovalFlowDetailVO> approvalFlowDetailDTOS
            , List<ApprovalFlowDetail> resultApprovalFlowDetails
        ...
        for(SysRole role : roles){
            if(role.getId().equals(approvalFlowDetailPojo.getRoleId())){
                approvalFlowDetail.setRoleId(role.getId());
