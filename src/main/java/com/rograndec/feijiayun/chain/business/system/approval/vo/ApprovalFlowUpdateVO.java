...
import com.rograndec.feijiayun.chain.business.system.approval.constant.ApprovalFlowDefaultFlag;
...
public class ApprovalFlowUpdateVO implements Serializable {
    /**
     * 主键ID
     */
    ...
    private List<ApprovalFlowDetailUdateVO> aFDList;
    ...
    public List<ApprovalFlowDetailUdateVO> getaFDList() {
        return aFDList;
    }

    public void setaFDList(List<ApprovalFlowDetailUdateVO> aFDList) {
    ...
    public static ApprovalFlowUpdateVO getApprovalFlow4approvalFlowVO(SaveOrUpdateApprovalFlowVO approvalFlowVO
            , Enterprise userEnterprise
            , Enterprise startEnterprise
            , UserVO user, boolean isSave) throws Exception {

        ApprovalFlowUpdateVO approvalFlow = new ApprovalFlowUpdateVO();
        ...
        approvalFlow.setDefaultFlag(ApprovalFlowDefaultFlag.FLAG_DEFAULT_NO.getValue());
        UserEnterpriseUtils.setUserCreateOrModify(approvalFlow,user,isSave);
        return approvalFlow;
    }

    public static ApprovalFlowUpdateVO getApprovalFlowVO4approvalFlow(SaveOrUpdateApprovalFlowVO approvalFlowVO
            , Enterprise userEnterprise
            , Enterprise startEnterprise
            , UserVO user, boolean isSave) throws Exception {
