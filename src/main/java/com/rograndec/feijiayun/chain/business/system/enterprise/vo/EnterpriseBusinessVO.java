...
@ApiModel(value = "EnterpriseBusinessVO", description = "企业业务信息对象")
public class EnterpriseBusinessVO implements Serializable {
    /**
     * 主键ID
     */
     ...
     * 会员信息（0-总部控制；1-自主控制）
     */
	@ApiModelProperty(required = false, value = "会员信息（0-总部控制；1-自主控制）,一期只读")
    private Integer memberInfo;

    /**
     * 促销规则（0-总部控制；1-自主控制）
     */
	@ApiModelProperty(required = false, value = "促销规则（0-总部控制；1-自主控制）,一期只读")
     ...
     * 价签打印（0-总部控制；1-自主控制）
     */
	@ApiModelProperty(required = false, value = "价签打印（0-总部控制；1-自主控制）,一期只读")
    private Integer priceTagPrint;

    /**
     * 提成规则（0-总部控制；1-自主控制）
     */
	@ApiModelProperty(required = false, value = "提成规则（0-总部控制；1-自主控制）,一期只读")
     ...
     * 合理库存（0-总部控制；1-自主控制）
     */
	@ApiModelProperty(required = false, value = "合理库存（0-总部控制；1-自主控制）,一期只读")
    private Integer reasonableStock;

    /**
     * 配送管理（0-总部控制；1-自主控制）
     */
	@ApiModelProperty(required = false, value = "配送管理（0-总部控制；1-自主控制）,一期只读")
    private Integer distributionManage;

    /**
     * 设备设备（0-总部控制；1-自主控制）
     */
	@ApiModelProperty(required = false, value = "设备设备（0-总部控制；1-自主控制）,一期只读")
