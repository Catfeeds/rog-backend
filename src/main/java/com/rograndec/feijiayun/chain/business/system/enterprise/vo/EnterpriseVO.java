...
@ApiModel(value = "EnterpriseInGoodsVO", description = "企业基本信息对象")
public class EnterpriseVO implements Serializable {
	
	EnterpriseBusinessVO enterpriseBusinessVO;
	
	
    public EnterpriseBusinessVO getEnterpriseBusinessVO() {
		return enterpriseBusinessVO;
	}

	public void setEnterpriseBusinessVO(
			EnterpriseBusinessVO enterpriseBusinessVO) {
		this.enterpriseBusinessVO = enterpriseBusinessVO;
	}

	/**
     * 主键ID
     */
	@ApiModelProperty(required = true, value = "主键ID，不可为空或0")
    private Long id;
     ...
     */
	@ApiModelProperty(required = true, value = "经济类型（0-国有经济；1-集体经济；2-私营经济；3-个体经济；4-联营经济；5-股份制；6-外商投资；7-港澳台投资；8-其它经济类）")
    private Integer economicType;

    /**
     * 经营方式（0-个人独自经营；1-合伙经营；2-有限责任公司；3-股份有限责任公司）
     */
	@ApiModelProperty(required = true, value = "经营方式（0-个人独自经营；1-合伙经营；2-有限责任公司；3-股份有限责任公司）")
     ...
     * 仓库地址
     */
	@ApiModelProperty(required = false, value = "仓库地址")
	...
	@ApiModelProperty(required = false, value = "雇员")
