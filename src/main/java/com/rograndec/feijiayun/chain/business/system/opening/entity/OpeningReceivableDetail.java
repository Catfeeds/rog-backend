...
/**
 * 
 * saas_opening_receivable_detail
 * 
 * 
 * @author rograndec
 * 
 * 2018-01-03
 */
public class OpeningReceivableDetail implements Serializable {
    /**
     * 主键ID
     */
     ...
     * 期初应收总单ID
     */
    @ApiModelProperty(value = "期初应收总单ID")
