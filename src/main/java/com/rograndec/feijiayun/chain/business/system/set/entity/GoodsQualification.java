...
public class GoodsQualification implements Serializable {
    /**
     * 主键ID
     */
    ...
    public static List<Long> getIds(List<GoodsQualification> goodsQualifications){

        return goodsQualifications.stream().map(GoodsQualification::getId).collect(Collectors.toList());
    }

    /**
     * saas_goods_qualification
     */
