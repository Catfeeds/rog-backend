 ...
 */
@Component
public class DistrReturnNoticeReportExcelComponent<T> {
	        ...
	        try {
	            ExcelWriter writer = new ExcelWriter() {
	                public void generate() throws Exception {
                        ...
                        this.createCell(16,quantity.get("quantity")+"");
                        this.createCell(19,quantity.get("amount")+"");
                        this.createCell(23,quantity.get("realAmount")+"");
                        this.createCell(26,quantity.get("notaxRealAmount")+"");
                        this.createCell(27,quantity.get("taxAmount")+"");
                        // 结束行
                        this.endRow(); 
	                    // 电子表格结束
	                    this.endSheet();
