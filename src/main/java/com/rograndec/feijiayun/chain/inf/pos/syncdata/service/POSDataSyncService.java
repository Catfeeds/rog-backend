...
public interface POSDataSyncService {
	 ...
	 * @author yuting.li
	 * @version 1.0 
	 * @date 2017年10月12日 上午10:07:36 
	 * @param param
	 * @return
	 * @throws Exception 
	 * @return List<Map<String,Object>>
	 */
	List<Map<String, Object>> getSysRole(Map<String, Object> param) throws Exception;
	
	/**
	 * 
	 * @Description: 获取员工-角色-关联数据
	 * @author yuting.li
	 * @version 1.0 
	 * @date 2017年10月12日 上午10:07:50 
	 * @param param
	 * @return
	 * @throws Exception 
	 * @return List<Map<String,Object>>
	 */
	List<Map<String, Object>> getUserRole(Map<String, Object> param) throws Exception;
	 ...
	 * @author yuting.li
	 * @version 1.0 
	 * @date 2017年10月14日 上午10:46:04 
	 * @param param
	 * @return
	 * @throws Exception 
	 * @return List<Map<String,Object>>
	 */
	List<Map<String, Object>> getGoodsBusiness(Map<String, Object> param) throws Exception;
	List<Map<String, Object>> getQualitySet(Map<String, Object> param) throws Exception;
	 ...
	 * @return Integer
	 */
	Integer countGoods(Map<String, Object> param) throws Exception;
	Integer countPriceOrderDetail(Map<String, Object> param) throws Exception;
	Integer countStock(Map<String, Object> param) throws Exception;
	 ...
	 * @return List<Map<String,Object>>
	 */
	List<Map<String, Object>> getPharmacySet(Map<String, Object> param) throws Exception;
	 ...
	 * @author yuting.li
	 * @version 1.0 
	 * @date 2017年10月16日 上午11:28:59 
	 * @param posStand
	 * @return
	 * @throws Exception 
	 * @return int
	 */
	Map<String,String> savePosStand(PosStand posStand) throws Exception;
	 ...
	 * @return Integer
	 */
	Long countByTableName(Map<String, Object> param) throws Exception;
