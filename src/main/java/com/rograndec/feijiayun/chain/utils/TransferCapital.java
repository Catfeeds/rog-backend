...
public class TransferCapital {
     ...
     * @param args
     */
    public static String transfer(BigDecimal a) {
        TransferCapital t2r = new TransferCapital();
        String s = t2r.cleanZero(t2r.splitNum(t2r.roundString(t2r.getNum(a))));
        return s;
    }
     ...
     */
    private String getNum(BigDecimal b) {
        String s = b.toString();
        if (this.checkNum(s)) {
            return s;
        } else {
