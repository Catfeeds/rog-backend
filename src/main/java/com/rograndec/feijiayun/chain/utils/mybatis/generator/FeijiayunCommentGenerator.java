package com.rograndec.feijiayun.chain.utils.mybatis.generator;
...
public class FeijiayunCommentGenerator implements CommentGenerator{
    ...
    public FeijiayunCommentGenerator() {
        super();
	...
	public void addModelClassComment(TopLevelClass topLevelClass, IntrospectedTable introspectedTable) {
	     ...
	     topLevelClass.addJavaDocLine(" * ");
	     topLevelClass.addJavaDocLine(" * " + currentDateStr);
	     topLevelClass.addJavaDocLine(" */");
	}
}
