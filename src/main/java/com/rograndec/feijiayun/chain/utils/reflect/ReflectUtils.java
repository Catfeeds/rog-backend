package com.rograndec.feijiayun.chain.utils.reflect;
...
//                e.printStackTrace();
    ...
    public static void setValueOfGet(Object object, String fieldName,Object... values) throws Exception {
        Field field = null;
        Class<?> clazz = object.getClass();
        for (; clazz != Object.class; clazz = clazz.getSuperclass()) {
            try {
                ...
                //执行get方法返回一个Object
                getMethod.invoke(object,values);
            } catch (Exception e) {
                //这里甚么都不要做！并且这里的异常必须这样写，不能抛出去。
                //如果这里的异常打印或者往外抛，则就不会执行clazz = clazz.getSuperclass(),最后就不会进入到父类中了
            }
     ...
     */
    public static Map<String,Object> getNotNullBeanFeild2Map(Object object) throws NoSuchFieldException, IntrospectionException, InvocationTargetException, IllegalAccessException {
        Class<?> clazz = object.getClass();
